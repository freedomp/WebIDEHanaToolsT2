...
sap.ui.define(['jquery.sap.global', 'sap/ui/base/Metadata', 'sap/m/IconTabBar', 'sap/ui/core/CustomData', 'sap/m/IconTabFilter'],
	function (jQuery, Metadata, IconTabBar, CustomData, IconTabFilter) {
		...
		ITBHelper.prototype._onIconTabFilterSelect = function (oEvent) {
			var oSelectedSection = oEvent.getParameter('item').data('selectedSection'),
				iScrollDuration = 0;
