/*eslint-disable no-eq-null,eqeqeq,camelcase,no-octal-escape,no-fallthrough,quotes,max-len,complexity,max-params,max-statements*/
// based on commit
//bdb63fa8a920e719bba315515fc59c2f2e0a28cb two anyKw tokens were created by mistake for quoted identifiers
define(
    [
        "rndrt/rnd",
    ...
    function (
        ...
        DdlScanner.createCopy = function(scanner) {
            var result = new DdlScanner(scanner.m_byte_code);
            result.doStrictSeparationOfTokensAtPlusMinus = scanner.doStrictSeparationOfTokensAtPlusMinus;
            result.doStrictSeparationOfTokensAtSlash = scanner.doStrictSeparationOfTokensAtSlash;
            result.createDotDotTokens = scanner.createDotDotTokens;
            result.createEnumIdTokens = scanner.createEnumIdTokens;
            result.createColonFollowedByIdTokens = scanner.createColonFollowedByIdTokens;
            result.createPipePipeTokens = scanner.createPipePipeTokens;
            result.createDashArrowNoWsTokens = scanner.createDashArrowNoWsTokens;
            return result;
        };
        ...
        DdlScanner.prototype.setInput = function(s,startPos,cursorPos) {
            ...
            while (this.tok_begin < s.length) {
                ...
                switch (s.charAt(this.tok_begin)) {
                    ...
                    case '@':
                        try {
                            if (s.charAt(this.tok_begin + 1) == '<') {
                                ...
                                var atLeToken = new Token(atLeNum, sub, Category.CAT_OPERATOR, this.tok_begin, this.line, this.column, false,
                                    ErrorState.Correct, 0);
                    ...
                    case '<':
                        if (s.charAt(this.tok_begin + 1) == '>') {
                            var sub4 = s.substring(this.tok_begin,this.tok_begin + 2);
                            if (this.isCursor(this.line,this.column,cursorPos)) {
                                this.addEmptyAnyKeywordToken();
                            }else if (this.isCursor(this.line,this.column + 1,cursorPos)) {
                                sub4 = sub4.substring(1);
                                this.addAnyKeywordToken("<");
                            }
                            this.m_input.push(new Token(this.ne,sub4,Category.CAT_OPERATOR,this.tok_begin,this.line,this.column,false,ErrorState.Correct,0));
                            this.tok_begin += 2;
                            this.column += 2;
                        }else if (s.charAt(this.tok_begin + 1) == '=') {
                            var sub2 = s.substring(this.tok_begin,this.tok_begin + 2);
                            if (this.isCursor(this.line,this.column,cursorPos)) {
                                this.addEmptyAnyKeywordToken();
                            }else if (this.isCursor(this.line,this.column + 1,cursorPos)) {
                            ...
                            this.m_input.push(new Token(this.se,sub2,Category.CAT_OPERATOR,this.tok_begin,this.line,this.column,false,ErrorState.Correct,0));
                            this.tok_begin += 2;
                            this.column += 2;
                        }else{
                    ...
                    case '>':
                        if (s.charAt(this.tok_begin + 1) == '=') {
                            var sub1 = s.substring(this.tok_begin,this.tok_begin + 2);
                            if (this.isCursor(this.line,this.column,cursorPos)) {
                                this.addEmptyAnyKeywordToken();
                            }else if (this.isCursor(this.line,this.column + 1,cursorPos)) {
                            ...
                            this.m_input.push(new Token(this.ge,sub1,Category.CAT_OPERATOR,this.tok_begin,this.line,this.column,false,ErrorState.Correct,0));
                            this.tok_begin += 2;
                            this.column += 2;
                        }else{
                    ...
                    case '*':
                        if ('/' == s.charAt(this.tok_begin + 1)) {
                            this.m_input.push(new Token(this.comment1,s.substring(this.tok_begin,this.tok_begin + 2),Category.CAT_COMMENT,this.tok_begin,this.line,this.column,false,ErrorState.Correct,0));
                            this.tok_begin += 2;
                            this.column += 2;
                        }else{
                                ...
                                try {
                                    ...
                                    while (true) {
                                        if (s.charAt(this.tok_end) == '*' && s.charAt(this.tok_end + 1) == '/') {
                                            ...
                                            columnPos += 2;
                                            break;
                                        }else if (DdlScanner.isNL(s.charAt(this.tok_end))) {
                                            var lineBreakLength1 = this.getLineBreakLength(s,this.tok_end);
                                            this.tok_end = this.tok_end + lineBreakLength1;
                                            linePos++;
                                            columnPos = 1;
                    ...
                    default :
                        ...
                        while (!DdlScanner.isWS(s.charAt(this.tok_end)) && !this.isPunctation(s,this.tok_end) && !(s.charAt(this.tok_end) == '{') && !(s.charAt(this.tok_end) == '}') && !(s.charAt(this.tok_end) == '\'') && !this.isLineComment(s,this.tok_end) && !(s.charAt(this.tok_end) == ';') && !(s.charAt(this.tok_end) == '=')) {
                            ...
                            if (s.charAt(this.tok_end) == '.') {
                                var isNumber = true;
                                var txt = s.substring(this.tok_begin, this.tok_end);
                        ...
                        if (this.inAnnotation) {
                            ...
                            if (this.annotationColonFound) {
                                ...
                                if ("@" === last.m_lexem && DdlScanner.isWS(previousChar) == false) {
                                    t.setPayload(new AnnotationPayload());
        ...
        DdlScanner.prototype.handleDashArrow = function(s, cursorPos) {
            ...
            if (this.createDashArrowNoWsTokens) {
                try {
                    ...
                    if (!(DdlScanner.isWS(previous)) && !(previous == '/')) {
                        if ((!DdlScanner.isWS(next) && !(next == '/')) || this.isCursor(this.line,this.column + dashArrow.length,cursorPos) || '\0' == next) {
            ...
            this.m_input.push(new Token(tokenNumber,lexem,Category.CAT_OPERATOR,this.tok_begin,this.line,this.column,false,ErrorState.Correct,0));
        ...
        DdlScanner.prototype.addAnyKeywordToken = function(lexem) {
            var t = new Token(this.anyKeyword, lexem, Category.CAT_INCOMPLETE, this.tok_begin, this.line, this.column, false,
                ErrorState.Correct, 0);
            this.m_input.push(t);
        };
        DdlScanner.prototype.handleColon = function(s,cursorPos) {
            ...
            try {
                ...
                if (nextChar == ':') {
                    ...
                    this.tok_begin += 2;
                    this.column += 2;
                }else if (this.createColonFollowedByIdTokens && (rnd.Utils.isLetter(nextChar) || '"' == nextChar)) {
        ...
        DdlScanner.prototype.initializeTokenNumbers = function() {
            ...
            this.se = this.getTokenIndex(SapDdlConstants.SE);
        ...
        DdlScanner.prototype.nextIsNumber = function(source,retNumberLiteral,retEndIndex,retNum) {
            try {
                ...
                while (DdlScanner.isNL(source.charAt(i))) {
                    i++;
                }
                var before = i;
                while (!DdlScanner.isWS(source.charAt(i)) && !this.isPunctation(source,i) && !(source.charAt(i) == '{') && !(source.charAt(i) == '}') && !(source.charAt(i) == '\'') && !this.isLineComment(source,i) && !(source.charAt(i) == ';') && !(source.charAt(i) == '=')) {
                    i++;
                }
        ...
        DdlScanner.prototype.consumeIdentifierStartingWithQuotationMark = function(s,cursorPos) {
            ...
            try {
                ...
                while (true) {
                    ...
                    this.column++;
                    if (this.isCursor(this.line,this.column,cursorPos)) {
                        var lexem = s.substring(start, this.tok_begin);
                        this.m_input.push(new Token(this.anyKeyword,lexem,Category.CAT_INCOMPLETE,start,this.line,startColumn,false,ErrorState.Correct,0));
                        start = this.tok_begin;
        ...
        DdlScanner.prototype.consumeCompleteLine = function(s) {
            this.tok_end = this.tok_begin;
            while (!DdlScanner.isNL(s.charAt(this.tok_end))) {
                this.tok_end++;
            }
        ...
        DdlScanner.prototype.handleHexLiteral = function(s) {
            ...
            if ((s.charAt(this.tok_begin) == 'x' || s.charAt(this.tok_begin) == 'X') && s.charAt(this.tok_begin + 1) == '\'') {
                try {
                    ...
                    while (s.charAt(this.tok_begin) != '\'' && !this.isPunctation(s,this.tok_begin) && !DdlScanner.isWS(s.charAt(this.tok_begin)));
                    if (!(DdlScanner.isWS(s.charAt(this.tok_begin)))) {
                        this.tok_begin++;
                        this.column++;
                    }
                }
        ...
        DdlScanner.prototype.processSingleCharWithOperatorInternal = function(s,c,token_num,cursorPos,category,separateTokenWithEmptyLexemForAnyKw) {
            if (s.charAt(this.tok_begin) == c) {
                if (this.isCursor(this.line,this.column,cursorPos)) {
                    ...
                    var lexemToBeAddedAfterAnyKw = null;
                    if ( "}" === sub || "," === sub || ";" === sub || ":" === sub || "{" === sub || "@" === sub || separateTokenWithEmptyLexemForAnyKw ) {
                        lexemToBeAddedAfterAnyKw = sub;
                        sub = "";
                    }
                    var t = new Token(this.anyKeyword, sub, Category.CAT_INCOMPLETE, this.tok_begin, this.line, this.column, false,
                        ErrorState.Correct, 0);
                    ...
                    if (separateTokenWithEmptyLexemForAnyKw) {
                        ...
                        this.handleAnnotationSingleChar(c,t);
                        this.m_input.push(t);
                    }else if (lexemToBeAddedAfterAnyKw != null) {
                        t = new Token(token_num,lexemToBeAddedAfterAnyKw,category,this.tok_begin,this.line,this.column,false,ErrorState.Correct,0);
                        this.m_input.push(t);
                    }
                }else{
                    var t1 = new Token(token_num, s.substring(this.tok_begin, this.tok_begin + 1), category, this.tok_begin, this.line,
                        this.column, false, ErrorState.Correct, 0);
                    this.handleAnnotationSingleChar(c,t1);
                    this.m_input.push(t1);
                }
                this.tok_begin++;
                this.column++;
            }
        ...
        DdlScanner.prototype.processLiteral = function(s,delimeter,nUM_SLITERAL,cursorPos) {
            if (s.charAt(this.tok_begin) == delimeter) {
                ...
                for (;;) {
                    ...
                    lColumn++;
                    if (this.isCursor(this.line,lColumn,cursorPos)) {
                        var tok_txt5 = s.substring(this.tok_begin,this.tok_end);
                        this.addAnyKeywordToken(tok_txt5);
                    }
                    if (s.charAt(this.tok_end) == delimeter && this.isNotEscaped(s)) {
                        ...
                        if (s.charAt(this.tok_end) != delimeter) {
                            if (this.isCursor(this.line,lColumn - 1,cursorPos)) {
                                var tok_txt4 = s.substring(this.tok_begin,this.tok_end - 1);
                                this.addAnyKeywordToken(tok_txt4);
                            }
                            var tok_txt2 = s.substring(this.tok_begin,this.tok_end);
                            var t = new Token(nUM_SLITERAL, tok_txt2, Category.CAT_LITERAL, this.tok_begin, startLine, startColumn, false,
                                ErrorState.Correct, 0);
                    ...
                    switch (s.charAt(this.tok_end)) {
                        case '\n':
                            ...
                            break;
                        case '\0':
                            var tok_txt1 = s.substring(this.tok_begin,this.tok_end);
                            var t1 = new Token(nUM_SLITERAL, tok_txt1, Category.CAT_LITERAL, this.tok_begin, startLine, startColumn, false,
                                ErrorState.Correct, 0);
                            this.handleAnnotationSingleChar('a',t1);
                            this.m_input.push(t1);
                            this.column = lColumn;
                            this.tok_begin = this.tok_end;
                            return;
