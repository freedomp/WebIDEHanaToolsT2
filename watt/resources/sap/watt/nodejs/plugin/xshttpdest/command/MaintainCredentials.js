define(function() {
	...
	return {
        ...
        _navigateToAdminister: function(ioWindow, isFileURI) {
            ioWindow.location.href = "/sap/hana/xs/admin/index.html?package=" + this._uriToParentURI(isFileURI).replace(/\//g, '.') + "&name=" + this._uriToFilenameWithoutSuffix(isFileURI) + "&type=xshttpdest";
        },
