...
jQuery.sap.declare("sap.watt.hanaplugins.editor.common.treemap.InlineEditor");

sap.ui.core.Control.extend("sap.watt.hanaplugins.editor.common.treemap.InlineEditor", {
    metadata: {
        properties: {
            "showEditor": {
                type: "boolean",
