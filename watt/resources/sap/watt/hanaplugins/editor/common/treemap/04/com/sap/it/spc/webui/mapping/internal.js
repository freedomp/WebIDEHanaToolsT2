...
com.sap.it.spc.webui.mapping.internal.IGraphicRenderer = function(mMethods) {
	...
	for (sMethodName in mMethods) {
		if(mMethods.hasOwnProperty(sMethodName)) {
	...
	if(
			((!!mMethods.placeAt && (typeof mMethods.placeAt === "function")) === false) || 
			((!!mMethods.drawCurve && (typeof mMethods.drawCurve === "function")) === false) || 
			((!!mMethods.deleteCurve && (typeof mMethods.deleteCurve === "function")) === false) ||
			((!!mMethods.renderGraphics && (typeof mMethods.renderGraphics === "function")) === false) ||
			((!!mMethods.removeGraphics && (typeof mMethods.removeGraphics === "function")) === false) ||
			((!!mMethods.highlight && (typeof mMethods.highlight === "function") === false)) ||
			((!!mMethods.clearHighlight && (typeof mMethods.clearHighlight === "function")) === false) ||
			((!!mMethods.toggleSelection && (typeof mMethods.toggleSelection === "function")) === false) ||
			((!!mMethods.clearSelection && (typeof mMethods.clearSelection === "function")) === false) ||
			((!!mMethods.registerExecution && (typeof mMethods.registerExecution === "function")) === false) ||
			((!!mMethods.deregisterExecution && (typeof mMethods.deregisterExecution === "function")) === false) ||
			((!!mMethods.cancelPreview && (typeof mMethods.cancelPreview === "function")) === false) ||
			((!!mMethods.showPreview && (typeof mMethods.showPreview === "function")) === false) ||
			((!!mMethods.getFunctionXY && (typeof mMethods.getFunctionXY === "function")) === false)
		) 
			{	
...
com.sap.it.spc.webui.mapping.internal.SVGRenderer.prototype.placeAt = function(sContainerId, sAreaId) {
	...
	$Container.css("top", parseInt($Container.css("top"), 10) + 27 + "px");
...
com.sap.it.spc.webui.mapping.internal.SVGRenderer.prototype.drawCurve = function(from, to, oAttrMap, aClasses) {
	...
	for (sAttrName in oAttrMap) {
		if(oAttrMap.hasOwnProperty(sAttrName)) {
...
com.sap.it.spc.webui.mapping.internal.SVGRenderer.prototype.renderGraphics = function(aConnectionInfos) {
	...
	for (i = 0; i < aConnectionInfos.length; i++) {
		...
		if (oConnectionInfo.source.length === 1
			...
			if(oCurve.classes) {
				oCurve.classes.sort(this._fnSort);
			}
			...
			if (pIcon) {
				...
				if (oPresentation && oPresentation.getIconSrc()) {
					...
					if(oIcon.classes) {
						oIcon.classes.sort(this._fnSort);
					}
...
com.sap.it.spc.webui.mapping.internal.SVGRenderer.prototype._showTooltip = function(sTooltipText, oPoint) {
	...
	var i;
	for (i = 0; i < oTooltipText.children.length; i++) {
