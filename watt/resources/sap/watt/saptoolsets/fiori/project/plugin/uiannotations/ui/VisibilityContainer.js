jQuery.sap.declare("sap.watt.saptoolsets.fiori.project.plugin.uiannotations.ui.VisibilityContainer");
sap.ui.core.Control.extend("sap.watt.saptoolsets.fiori.project.plugin.uiannotations.ui.VisibilityContainer", {
	metadata: {
		properties: {
			visible: {
				type: "boolean",
