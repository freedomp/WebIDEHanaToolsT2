...
sap.ui.define(['jquery.sap.global', 'sap/ui/base/Metadata', './ObjectPageSubSection'],
	function (jQuery, Metadata, ObjectPageSubSection) {
		"use strict";
		...
		LazyLoading.prototype._isPhone = function () {
			return this._$html.hasClass("sapUiMedia-Std-Phone") || sap.ui.Device.system.phone;
		};
