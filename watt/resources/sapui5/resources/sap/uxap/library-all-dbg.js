...
sap.ui.define("sap/uxap/AnchorBarRenderer",['sap/m/ToolbarRenderer','sap/ui/core/Renderer'],
...
jQuery.sap.require('sap.ui.core.Renderer'); // unlisted dependency retained
sap.ui.define("sap/uxap/BlockBaseRenderer",['sap/ui/core/Renderer'],
	function(Renderer) {
	"use strict";
...
jQuery.sap.require('sap.ui.core.Renderer'); // unlisted dependency retained
sap.ui.define("sap/uxap/BreadCrumbsRenderer",['sap/ui/core/Renderer'],
	function(Renderer) {
	"use strict";
...
jQuery.sap.require('sap.ui.core.Renderer'); // unlisted dependency retained
sap.ui.define("sap/uxap/ObjectPageHeaderRenderer",['sap/ui/core/Renderer'],
	function(Renderer) {
	"use strict";
...
if ( !jQuery.sap.isDeclared('sap.uxap.ObjectPageLayoutITBHelper') ) {
/*!
 * SAP UI development toolkit for HTML5 (SAPUI5) (c) Copyright
		2009-2015 SAP SE. All rights reserved
 */

jQuery.sap.declare('sap.uxap.ObjectPageLayoutITBHelper'); // unresolved dependency added by SAPUI5 'AllInOne' Builder
jQuery.sap.require('jquery.sap.global'); // unlisted dependency retained
jQuery.sap.require('sap.ui.base.Metadata'); // unlisted dependency retained
jQuery.sap.require('sap.m.IconTabBar'); // unlisted dependency retained
jQuery.sap.require('sap.ui.core.CustomData'); // unlisted dependency retained
jQuery.sap.require('sap.m.IconTabFilter'); // unlisted dependency retained
sap.ui.define("sap/uxap/ObjectPageLayoutITBHelper",['jquery.sap.global', 'sap/ui/base/Metadata', 'sap/m/IconTabBar', 'sap/ui/core/CustomData', 'sap/m/IconTabFilter'],
...
}; // end of sap/uxap/ObjectPageLayoutITBHelper.js
...
sap.ui.define("sap/uxap/ObjectPageSectionRenderer",[],
	function () {
		"use strict";
...
jQuery.sap.require('sap.ui.core.Renderer'); // unlisted dependency retained
sap.ui.define("sap/uxap/ObjectPageSubSectionRenderer",['sap/ui/core/Renderer'], function (Renderer) {
	"use strict";
...
sap.ui.define("sap/uxap/component/Component",['sap/uxap/ObjectPageConfigurationMode'],
...
jQuery.sap.require('sap.uxap.ObjectPageConfigurationMode'); // unlisted dependency retained
sap.ui.define("sap/uxap/component/ObjectPageComponentContainer",['sap/ui/core/ComponentContainer','sap/uxap/ObjectPageConfigurationMode'],
...
sap.ui.define("sap/uxap/library",['sap/ui/core/Core','sap/ui/core/library'],
...
jQuery.sap.require('jquery.sap.global'); // unlisted dependency retained
jQuery.sap.require('sap.m.Select'); // unlisted dependency retained
sap.ui.define("sap/uxap/HierarchicalSelect",['jquery.sap.global', 'sap/m/Select', './library'],
...
jQuery.sap.require('sap.ui.core.ResizeHandler'); // unlisted dependency retained
sap.ui.define("sap/uxap/ObjectPageHeader",['sap/ui/core/Control', 'sap/ui/core/IconPool', 'sap/uxap/BreadCrumbs', 'sap/ui/core/ResizeHandler' , './library'],
...
sap.ui.define("sap/uxap/ObjectPageHeaderActionButton",['sap/m/Button','./library'],
...
jQuery.sap.require('sap.ui.core.Control'); // unlisted dependency retained
sap.ui.define("sap/uxap/ObjectPageHeaderContent",['sap/ui/core/Control','./library'],
...
jQuery.sap.require('sap.ui.core.Renderer'); // unlisted dependency retained
sap.ui.define("sap/uxap/ObjectPageHeaderContentRenderer",['sap/ui/core/Renderer','./ObjectPageHeaderRenderer'],
	function(Renderer, ObjectPageHeaderRenderer) {
	"use strict";
...
sap.ui.define("sap/uxap/ObjectPageHeaderLayoutData",['sap/ui/core/LayoutData','./library'],
...
jQuery.sap.require('jquery.sap.global'); // unlisted dependency retained
jQuery.sap.require('sap.ui.core.Control'); // unlisted dependency retained
sap.ui.define("sap/uxap/ObjectPageSectionBase",[	'jquery.sap.global', 'sap/ui/core/Control', './library'],
...
jQuery.sap.require('sap.ui.core.Control'); // unlisted dependency retained
jQuery.sap.require('sap.ui.core.CustomData'); // unlisted dependency retained
sap.ui.define("sap/uxap/BlockBase",['sap/ui/core/Control', 'sap/ui/core/CustomData', './BlockBaseMetadata', './ModelMapping', './library'],
...
jQuery.sap.require('sap.ui.core.CustomData'); // unlisted dependency retained
jQuery.sap.require('sap.m.Button'); // unlisted dependency retained
sap.ui.define("sap/uxap/ObjectPageLayoutABHelper",['jquery.sap.global', 'sap/ui/base/Metadata', 'sap/ui/core/CustomData', './AnchorBar', 'sap/m/Button'],
...
jQuery.sap.require('sap.m.Button'); // unlisted dependency retained
sap.ui.define("sap/uxap/ObjectPageSection",['jquery.sap.global', 'sap/ui/core/InvisibleText', './ObjectPageSectionBase', 'sap/ui/Device', 'sap/m/Button', './library'],
...
sap.ui.define("sap/uxap/ObjectPageSubSection",['sap/ui/core/CustomData', 'sap/ui/layout/Grid', './ObjectPageSectionBase', './ObjectPageSubSectionLayout',
...
sap.ui.define("sap/uxap/component/ObjectPageLayoutUXDrivenFactory.controller",['sap/ui/layout/GridData','sap/ui/model/BindingMode','sap/uxap/BlockBase','sap/uxap/ModelMapping'],
...
jQuery.sap.require('jquery.sap.global'); // unlisted dependency retained
jQuery.sap.require('sap.ui.base.Metadata'); // unlisted dependency retained
sap.ui.define("sap/uxap/LazyLoading",['jquery.sap.global', 'sap/ui/base/Metadata', './ObjectPageSubSection'],
