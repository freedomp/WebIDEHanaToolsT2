window.TEST_REGEXP = /sane-tests\/ci_tests\/service_initialization_tests\/.*Spec\.js$/i;
window.allTestFiles = [
	'ci_tests/service_initialization_tests/services/servicesSpec'
];

window.customPaths = {
	'service_initialization_tests': window.webappPath() + 'test-resources/sap/watt/sane-tests/ci_tests/service_initialization_tests',
