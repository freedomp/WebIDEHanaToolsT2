...
define(["watt/resources/sap/watt/hanaplugins/editor/plugin/cds/model/model",
		...
		"watt/resources/sap/watt/hanaplugins/editor/plugin/cds/view/columns/AssociationsPane",
		"watt/resources/sap/watt/hanaplugins/editor/plugin/cds/view/CDSEditorUtil"
       ], 

    function(viewmodel, Parser,AssociationsPane,CDSEditorUtil) {
		...
		var associationsPane = new AssociationsPane({
            model: model,
        ...
        var columnPane = associationsPane.getContent();
