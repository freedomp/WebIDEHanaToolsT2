...
sap.ui.define(['jquery.sap.global', 'sap/ui/core/InvisibleText', './ObjectPageSectionBase', 'sap/ui/Device', 'sap/m/Button', './library'],
	function (jQuery, InvisibleText, ObjectPageSectionBase, Device, Button, library) {
		...
		ObjectPageSection.prototype._getShowHideButtonText = function (bHide) {
			return this._getResourceBundle().getText(bHide ? "HIDE" : "SHOW");
		};

		ObjectPageSection.prototype._getShowHideAllButtonText = function (bHide) {
			return this._getResourceBundle().getText(bHide ? "HIDE_ALL" : "SHOW_ALL");
		};
