...
(function() {
	...
	var VBIScriptFiles = [
		...
		"sapresources", "sapgeomath", "sapmaplayer", "sapmapprovider", "sapmapmanager", "sapvoutils", "sapvobase", // visual objects base and vo implementation
...
// if the setDragImage is not available, implement it
	...
	if (typeof window.DataTransfer.prototype.setDragImage !== 'function') {
		window.DataTransfer.prototype.setDragImage = function(image, offsetX, offsetY) {
			var randomDraggingClassName, dragStylesCSS, dragStylesEl, headEl, parentFn, eventTarget;
			 ...
			 * event
			 */
			parentFn = window.DataTransfer.prototype.setDragImage.caller;
			while (!(parentFn.arguments[0] instanceof window.DragEvent)) {
