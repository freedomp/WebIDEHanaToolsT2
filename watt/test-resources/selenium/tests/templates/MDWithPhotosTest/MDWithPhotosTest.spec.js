...
describe('Generate_MD_with_Photos', function () {
	'use strict';
	...
	it('Generate MD with photos project', function () {
		var that = this;
	...
	function configureTemplateCustomizationstep(templateCustomizationWizardPage){
		...
		return driver.myWaitAndSendKeys("DamageReportSet",templateCustomizationODataCollection, configuration.defaultTimeout).then(function(){
				return templateCustomizationWizardPage.enterTemplateCustomizationText("DamageReport", 1, 'Title attribute from the OData collection');
			}).then(function(){
				return templateCustomizationWizardPage.enterTemplateCustomizationText("Status", 1, 'Status attribute from the OData collection');
			}).then(function(){
				return templateCustomizationWizardPage.enterTemplateCustomizationText("ClaimedsumCurrencyCode", 1, 'Unit of Measure from the OData collection');
			}).then(function(){
				return templateCustomizationWizardPage.enterTemplateCustomizationText("CreatedOn", 1, 'Date attribute from the OData collection');
			}).then(function(){
				return templateCustomizationWizardPage.enterTemplateCustomizationText(configuration.detailsPageTitle, 2, 'Title');
			}).then(function(){
				return templateCustomizationWizardPage.enterTemplateCustomizationText("CheckedOn", 2, 'Editable date attribute from the OData collection');
			}).then(function(){
				return templateCustomizationWizardPage.enterTemplateCustomizationText("Comment", 2, 'Editable text attribute from the OData collection');
			}).then(function(){
				return templateCustomizationWizardPage.clickTemplateCustomizationCheckbox(2, 'Add Approve/Reject buttons');
			}).then(function(){
				return templateCustomizationWizardPage.enterTemplateCustomizationText("AttachmentSet", 3, 'Photos OData collection');
			}).then(function(){
