 ...
 * <li>Events
 * <ul>
 * <li>{@link com.sap.it.spc.webui.mapping.MessageTreeTable#event:contentUpdate contentUpdate} : fnListenerFunction or [fnListenerFunction, oListenerObject] or [oData, fnListenerFunction, oListenerObject]</li></ul>
 * </li>
 * </ul> 
 *
 * 
 ...
 *
 * @class
 * The structure of message (Source/Target) is represented using this control. This extends TreeTable control of ui5 providing an additional event 'contentUpdate' when the content in the table is updated
 ...
 */
sap.ui.table.TreeTable.extend("com.sap.it.spc.webui.mapping.MessageTreeTable", { metadata : {
...
/**
 * Creates a new subclass of class com.sap.it.spc.webui.mapping.MessageTreeTable with name <code>sClassName</code> 
...
com.sap.it.spc.webui.mapping.MessageTreeTable.M_EVENTS = {'contentUpdate':'contentUpdate'};
...
/**
 * Attach event handler <code>fnFunction</code> to the 'contentUpdate' event of this <code>com.sap.it.spc.webui.mapping.MessageTreeTable</code>.<br/>.
...
/**
 * Detach event handler <code>fnFunction</code> from the 'contentUpdate' event of this <code>com.sap.it.spc.webui.mapping.MessageTreeTable</code>.<br/>
 *
...
com.sap.it.spc.webui.mapping.MessageTreeTable.prototype._calculateRowsToDisplay = function(iHeight) {
	var $this = this.$();
	...
	return Math.max(1, Math.floor(iAvailableSpace/iRowHeight));
};
