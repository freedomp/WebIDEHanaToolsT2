define(["STF", "sinon"], function(STF, sinon) {
	...
	var suiteName = "hcp_ui5_libraries_loaded_service_tests";
	var suiteWindowObj;
	var sandbox;
	...
	sContent += "\txmlns:m=\"sap.m\"\n";
	sContent += "\txmlns:me=\"sap.me\"\n";
	...
	sContent += "\txmlns:suite=\"sap.suite.ui.commons\"\n";
	sContent += "\txmlns:core=\"sap.ui.core\">\n";
	sContent += "\t<com:Tree xmlns=\"sap.m\" showHorizontalScrollbar=\"\" >\n";
	sContent += "\t</com:Tree>\n";
	sContent += "\t<m:ActionSheet xmlns=\"sap.m\" cancelButtonTap=\"\" >\n";
	sContent += "\t</m:ActionSheet>\n";
	sContent += "\t<rta:>\n";
	sContent += "\t</rta:>\n";
	sContent += "\t<ux3:>\n";
	sContent += "\t</ux3:>\n";
	...
	sContent2 += "\txmlns:table=\"sap.ui.table\"\n";
	...
	sContent2 += "\t<core:Control busy=\"\" >\n";
	sContent2 += "\t\t<core:Element parseError=\"\"  ></core:Element>\n";
	sContent2 += "\t</core:Control>\n";
	sContent2 += "</core:View>";

	describe.skip("Xml Code Completion Service", function() {
		before(function() {
			return STF.startWebIde(suiteName, {
				config: "ci_tests/editor_ci/xml/service/config.json"
			}).
		...
		beforeEach(function() {
			...
			var oDocument = new MockFileDocument("new/doc.xml", "xml", "");
