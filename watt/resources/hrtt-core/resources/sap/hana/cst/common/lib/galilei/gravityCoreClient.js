...
(function CallbackHandler () {
	...
	var logger = com.sap.gravity.getLogger("CallbackHandler");
	...
	this.com.sap.gravity.createCallbackHandler = function createCallbackHandler () {
		var callbacks = [];
...
(function Participant () {
    ...
    this.com.sap.gravity.createParticipant = function (model, id, isLocal) {
 ...
 *
 */
this.com.sap.gravity.createOperationalizer = function() {
	...
	var createIdOperationInternal = function (context_vector, client_offset, is_inverse, original_operation) {
		if (context_vector && $.isArray(context_vector)) {
			return com.sap.gravity.beget(id_operation, {
			    "operation_id" : Math.uuid(),
	...
	var createAddNodeOperationInternal = function (context_vector, client_offset, identity, is_inverse, original_operation, initial_attribute_values) {
		...
		if (context_vector && $.isArray(context_vector)) {
			return com.sap.gravity.beget(add_node_operation, {
			    "operation_id" : Math.uuid(),
				"context_vector": context_vector.slice(0),
				"client_offset": client_offset,
				"object_id": identity,
	...
	var createRemoveNodeOperationInternal = function (context_vector, client_offset, identity, is_inverse, original_operation, to_be_deleted_attribute_values) {
		if (context_vector && $.isArray(context_vector)) {
			return com.sap.gravity.beget(remove_node_operation, {
			    "operation_id" : Math.uuid(),
				"context_vector" : context_vector.slice(0),
				"client_offset" : client_offset,
				"object_id" : identity,
	...
	var createSetAttributeOperationInternal = function (context_vector, client_offset, identity, attribute_name, old_value, new_value, is_inverse, original_operation) {
		if (context_vector && $.isArray(context_vector)) {
			return com.sap.gravity.beget(set_attribute_operation, {
			    "operation_id" : Math.uuid(),
				"context_vector" : context_vector.slice(0),
				"client_offset" : client_offset,
				"object_id" : identity,
	...
	var createSetAtomicReferenceOperationInternal = function (context_vector, client_offset, identity, reference_name, old_target_id, new_target_id, is_inverse, original_operation) {
		if (context_vector && $.isArray(context_vector)) {
			return com.sap.gravity.beget(set_reference_operation, {
			    "operation_id" : Math.uuid(),
				"context_vector" : context_vector.slice(0),
				"client_offset" : client_offset,
				"object_id" : identity,
	...
	var createAddOrderedReferenceOperationInternal = function (context_vector, client_offset, identity, reference_name, target_id, index, is_inverse, original_operation) {
		if (context_vector && $.isArray(context_vector)) {
			return com.sap.gravity.beget(add_reference_operation, {
			    "operation_id" : Math.uuid(),
				"context_vector" : context_vector.slice(0),
				"client_offset" : client_offset,
				"object_id" : identity,
	...
	var createRemoveOrderedReferenceOperationInternal = function (context_vector, client_offset, identity, reference_name, target_id, index, is_inverse, original_operation) {
		if (context_vector && $.isArray(context_vector)) {
			return com.sap.gravity.beget(remove_reference_operation, {
			    "operation_id" : Math.uuid(),
				"context_vector" : context_vector.slice(0),
				"client_offset" : client_offset,
				"object_id" : identity,
	...
	var createInsertStringOperationInternal = function (context_vector, client_offset, identity, attribute_name, subString, position, is_inverse, original_operation) {
		if(context_vector && $.isArray(context_vector)) {
			return com.sap.gravity.beget(insert_string_operation, {
				"operation_id" : Math.uuid(),
				"context_vector" : context_vector.slice(0),
				"client_offset" : client_offset,
				"object_id" : identity,
	...
	var createRemoveStringOperationInternal = function(context_vector, client_offset, identity, attribute_name, subString, position, is_inverse, original_operation) {
		if(context_vector && $.isArray(context_vector)) {
			return com.sap.gravity.beget(remove_string_operation, {
				"operation_id" : Math.uuid(),
				"context_vector" : context_vector.slice(0),
				"client_offset" : client_offset,
				"object_id" : identity,
    ...
    var createComplexOperationInternal = function (sequence) {
        ...
        var complexOp = com.sap.gravity.beget(complex_operation, {
            "sequence" : sequence
        });

        for (var i = 0, ii = sequence.length; i < ii; i+=1) {
            if (i>0 && !com.sap.gravity.equals(sequence[i-1].timestamp(), sequence[i].getContext())) {
	...
	id_operation = com.sap.gravity.beget(generic_operation, {
		flavor : flavors.id,
	...
	add_node_operation = com.sap.gravity.beget(generic_operation, {
		flavor : flavors.add,
        ...
        requiresTransform: function (operation) {
            ...
            case flavors.rewire:
            case flavors.update:
            case flavors.insertString: //@author: D057184
            case flavors.removeString: //@author: D057184
                return false;
            }
        },
	...
	remove_node_operation = com.sap.gravity.beget(generic_operation, {
     ...
     * </ul>
     */
	set_attribute_operation = com.sap.gravity.beget(generic_operation, {
     ...
     * </ul>
     */
	set_reference_operation = com.sap.gravity.beget(generic_operation, {
	...
	add_reference_operation = com.sap.gravity.beget(generic_operation, {
		flavor : flavors.wire,
	...
	remove_reference_operation = com.sap.gravity.beget(generic_operation, {
	...
	//@author: D057184
	insert_string_operation = com.sap.gravity.beget(generic_operation, {
	...
	//@author: D057184
	remove_string_operation = com.sap.gravity.beget(generic_operation, {
	...
	complex_operation = {
		...
		addPrimitiveOp : function (operation) {
			...
			if (length > 0 && !com.sap.gravity.equals(this.sequence[length-1].timestamp(), operation.getContext())) {
...
this.com.sap.gravity.createOperationGenerator = function (model, client_offset) {

    var operationalizer = com.sap.gravity.createOperationalizer();

    var currentComplexOperation = operationalizer.createComplexOperation();

    var logger = com.sap.gravity.getLogger("OperationGenerator");
    ...
    var modelListener = {
        ...
        nodeRemoved : function(node, attribute_values) {
             ...
             */
            if (model.isProtectedFromUndo !== true) {
                addToComplexOperation(operationalizer.createRemoveNodeOperation(
 ...
 *
 */
this.com.sap.gravity.createModel = function(lockedByModelHandler) {

    if (typeof (lockedByModelHandler) !== "function") {
        lockedByModelHandler = function () {return false;};
    }
    ...
    var listeners = com.sap.gravity.createSubscriptionHandler();

    var logger = com.sap.gravity.getLogger("Model");
    ...
    var addNodeInternal = function(identity, attribute_values) {
        ...
        var node = com.sap.gravity.createNode(identity, attribute_values, nodeChangeListener, lockedByModelHandler);
...
(function () {
    ...
    Node.prototype = (function() {
         ...
         * @return the operation ready to be enqueued
         * @member com.sap.gravity.model-Node
         */
        ...
        /** @lends com.sap.gravity.model-Node */
        return {
            constructor : Node,
            /**
	...
	this.com.sap.gravity.createNode = function (identity, attribute_values, changeListener, lock) {
	   attribute_values = attribute_values || {};
 ...
 */
this.com.sap.gravity.createModelHandler = function(configuration) {

    var execution_history;

    var original_history;

    var transformer = com.sap.gravity.createTransformer(configuration);
    ...
    var logger = com.sap.gravity.getLogger("ModelHandler");
    ...
    var model = com.sap.gravity.createModel(modelLock);
    var annotatingModel = com.sap.gravity.createAnnotatingModelWrapper(model);
    var participantId;
    var bufferedListener = com.sap.gravity.createBufferedModelListener();
    ...
    var doSanityCheck = function(remote_operation) {
         ...
         */
        if (com.sap.gravity.strictlyPrior(timestamp, remote_operation.getContext())) {
        ...
        if (com.sap.gravity.prior(remote_operation.timestamp(), timestamp)) {
         ...
         */
        if (com.sap.gravity.strictlyPrior(remote_operation.getContext(), original_history.getMinimumTimestamp())) {
    ...
    var changeModelInternal = function(command, description) {
        ...
        var checkSanity = function () {
            if (!com.sap.gravity.equals(execution_history.getTimestamp(), original_history.getMaximumTimeStamp())) {
    ...
    var initializeInternal = function(clientOffset, initialTimestamp, redoLog, read_only) {
        var initializeHelper = function () {
            ...
            generator = com.sap.gravity.createOperationGenerator(model, client_offset);
            original_history = com.sap.gravity.createWorkload(timestamp);
            execution_history = com.sap.gravity.createExecutionHistory(timestamp);
            pendingOperationsQueue = com.sap.gravity.createQueue(timestamp);
            pendingOperationsQueue.addOnAcknowledge(function(op) {
                notifyCallback(op, "onAcknowledge");
            });   
            undoHandler = com.sap.gravity.createUndoRedoHandler(changeModelInternal, transformer, original_history, execution_history);
        };
    ...
    var internalInterface = {
        applyRemoteOperation : function(remoteOperation) {
            ...
            if (!com.sap.gravity.equals(timestamp, original_history.getMaximumTimeStamp())) {
        ...
        changeModel : function(command, description, isProtectedFromUndo, isNested) {
            var operationIndex,
                ...
                operation,
                model,
                topLevelProtectedFromUndoCommand;
            ...
            if (isProtectedFromUndo === true) {
                try {
                    ...
                    if (model.isProtectedFromUndo === undefined) {
                    ...
                    if (topLevelProtectedFromUndoCommand === command) {
...
com.sap.gravity.createUndoRedoHandler = function (changeModelInternal, transformer, originalHistory, executionHistory) {
    ...
    return {
        ...
        makeUndoable : function (complexOperation, changeHandle) {
            ...
            redoStack = [];   
            changeHandle.onCollision(function () {undoStack = [];});            
        },
...
this.com.sap.gravity.createReplayHandler = function(client) {
    ...
    var subscriptions = com.sap.gravity.createSubscriptionHandler();
...
(function SubscriptionHandler () {
    ...
    var logger = com.sap.gravity.getLogger("SubscriptionHandler");
    ...
    this.com.sap.gravity.createSubscriptionHandler = function() {
        var subscribers = [];
 ...
 */
this.com.sap.gravity.createExecutionHistory = function (initialTimestamp) {
    ...
    return {
        ...
        addOperation : function (operation) {
            ...
            if (!com.sap.gravity.equals(operation.getContext(), this.getTimestamp())) {
        ...
        collectGarbage: function (timestamp) {
			for (var i = 0; i < history.length; i+=1) {
                var op = history[0];
                if (com.sap.gravity.strictlyPrior(op.getContext(), timestamp)) {
                    history.shift();
 ...
 * @param initialTimestamp {Array} the initial time stamp
 */
this.com.sap.gravity.createQueue = function (initialTimestamp) {
    ...
    var onQueueChangeCallbacks = com.sap.gravity.createCallbackHandler();
    var onAcknowledgeCallbacks = com.sap.gravity.createCallbackHandler();
    
    var log = com.sap.gravity.getLogger("Queue");
    
    var acknowledgeTimestamp = function (timestamp) {
        var op;
        for (var i = operationsQueue.length - 1; i >= 0; i-=1) {
            op = operationsQueue[i];
            if (com.sap.gravity.prior(op.timestamp(), timestamp)) {
    ...
    return {
        ...
        getOperations : function ()  {
            return operationsQueue.slice(0);
        },
 ...
 *         the cache.
 */
this.com.sap.gravity.createCache = function (capacity) {
	capacity = capacity || 1;
			...
			if (data) {
				...
				if (versions) {
					...
					for ( var i = 0, ii = versions.length; i < ii; i+=1) {
						...
						// vector
						version = versions[i];
						if (version && com.sap.gravity.equals(version.getContext(), context) && (version.getOriginalOperation() || version)===original) {
							version.usage += 1;
		...
		collectGarbage : function(timestamp) {
			...
			for (key in cache) {
				if (cache.hasOwnProperty(key)) {
					var data = cache[key];
					if (com.sap.gravity.prior(data.original.timestamp(), timestamp)) {
						delete cache[key];
 ...
 *
 ******************************************************************************/
this.com.sap.gravity.createTransformer = function(configuration) {

	/**
	 * the cache for storing transformed operations
	 */
	var cache = com.sap.gravity.createCache(1);
	 ...
	 */
	var operations = com.sap.gravity.createOperationalizer();
	 ...
	 */
	var onCollisionCallbacks = com.sap.gravity.createCallbackHandler();
	 ...
	 */
	var removeOperationsFromContext = function(complex_operation,
			list_of_operations_to_remove_from_context) {
		var i, ii, j, jj;
		var op;
		var primitives = complex_operation.getPrimitiveOps();
		var context;
	...
	var excludeEffects = function(op, opList) {
		...
		var opList_trans = [];
		var tempHistory = com.sap.gravity.createWorkload(op.getContext());
			...
			try {
				...
				if (op.getPrimitiveOps()[0]
					...
					if (retainLocalOps) {
						...
						var workload = com.sap.gravity.createWorkload();
	...
	var cotInternal = function(op, client) {
		...
		case "identity":
		case "insertString": //@author D057184
		case "removeString": //@author D057184
...
this.com.sap.gravity.createBufferedModelListener = function () {
...
this.com.sap.gravity.createUmHelper = function() {
 ...
 * @return
 */
this.com.sap.gravity.enableForCluster = function enableForCluster (modelId, path) { 
 ...
 * 
 */
this.com.sap.gravity.createWorkload = function (initial_offsets) {
     ...
     * shortcut to the logger
     */
    var log = com.sap.gravity.getLogger("Workload");
    ...
    return {
        ...
        operationContextDifference: function (operation1, operation2) {
            ...
            var difference = com.sap.gravity.createWorkload(operation2.getContext().slice(0));
        ...
        contextDifference: function (operation) {
            var difference = com.sap.gravity.createWorkload(operation.getContext().slice(0));
...
(function AnnotatingModel () {
    this.com.sap.gravity.createAnnotatingModelWrapper = function createAnnotatingModelWrapper (wrappedModel) {
        var wrapper = {},
            participantId;
...
this.com.sap.gravity.createModelInitializer = function(modelHandler) {
...
this.com.sap.gravity.createParticipantInitializer = function(modelHandler) {
    
    var onParticipantInitialized = com.sap.gravity.createCallbackHandler(),
        logger = com.sap.gravity.getLogger("ColorPicker");
