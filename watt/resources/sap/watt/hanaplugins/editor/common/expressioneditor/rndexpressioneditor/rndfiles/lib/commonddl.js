...
define(
    'commonddl/astmodel/CompilationUnitImpl',["commonddl/astmodel/StatementContainerImpl","commonddl/astmodel/EObjectContainmentEList","rndrt/rnd"], //dependencies
...
define(
    'commonddl/astmodel/AnnotationNameValuePairImpl',["commonddl/astmodel/SourceRangeImpl","commonddl/astmodel/EObjectContainmentEList","rndrt/rnd"], //dependencies
...
define(
    'commonddl/astmodel/AnnotationValueImpl',["commonddl/astmodel/AbstractAnnotationValueImpl","rndrt/rnd"], //dependencies
...
define(
    'commonddl/astmodel/NamedDeclarationImpl',["commonddl/astmodel/SourceRangeImpl","rndrt/rnd"], //dependencies
...
if (this.getArrayToken() != null || this.getCardinalityStartToken() != null) {
        ...
        ElementDeclarationImpl.prototype.eGet = function(featureID,resolve,coreType) {
            switch (featureID) {
                ...
                case IAstPackage.ELEMENT_DECLARATION__ARRAY_TOKEN:
                    return this.getArrayToken();
                case IAstPackage.ELEMENT_DECLARATION__ARRAY_OF_TOKEN:
                    return this.getArrayOfToken();
            }
        ...
        ElementDeclarationImpl.prototype.eIsSet = function(featureID) {
            switch (featureID) {
                ...
                case IAstPackage.ELEMENT_DECLARATION__ARRAY_TOKEN:
                    return ElementDeclarationImpl.ARRAY_TOKEN_EDEFAULT == null ? this.arrayToken != null : !ElementDeclarationImpl.ARRAY_TOKEN_EDEFAULT===arrayToken;
                case IAstPackage.ELEMENT_DECLARATION__ARRAY_OF_TOKEN:
                    return ElementDeclarationImpl.ARRAY_OF_TOKEN_EDEFAULT == null ? this.arrayOfToken != null : !ElementDeclarationImpl.ARRAY_OF_TOKEN_EDEFAULT===arrayOfToken;
            }
...
define(
    'commonddl/astmodel/AttributeDeclarationImpl',["commonddl/astmodel/ElementDeclarationImpl","rndrt/rnd"], //dependencies
 ...
 * 49683abaa8f3892cce0c444f268c430996e638a0 Enhance AST to Support References to Constants in Annotation Values
 */
define('commonddl/astmodel/AnnotationPathValueImpl',["commonddl/astmodel/AbstractAnnotationValueImpl"

], // dependencies
function(AbstractAnnotationValueImpl

) {
    AnnotationPathValueImpl.prototype = Object
            .create(AbstractAnnotationValueImpl.prototype);
    AnnotationPathValueImpl.prototype.namePath = null;
    function AnnotationPathValueImpl() {
        AbstractAnnotationValueImpl.call(this);
    }
    AnnotationPathValueImpl.prototype.eStaticClass = function() {
        return IAstPackage.Literals.ANNOTATION_PATH_VALUE;
    };
    AnnotationPathValueImpl.prototype.getNamePath = function() {
        return this.namePath;
    };
    AnnotationPathValueImpl.prototype.basicSetNamePath = function(newNamePath,
            msgs) {
        var oldNamePath = this.namePath;
        this.namePath = newNamePath;
        return msgs;
    ...
    AnnotationPathValueImpl.prototype.eInverseRemove = function(otherEnd,
            featureID, msgs) {
        switch (featureID) {
        case IAstPackage.ANNOTATION_PATH_VALUE__NAME_PATH:
            return this.basicSetNamePath(null, msgs);
        }

    };
    AnnotationPathValueImpl.prototype.eGet = function(featureID, resolve,
            coreType) {
        switch (featureID) {
        case IAstPackage.ANNOTATION_PATH_VALUE__NAME_PATH:
            return this.getNamePath();
        }
        return AbstractAnnotationValueImpl.prototype.eGet.call(this, featureID,
                resolve, coreType);
    };
    AnnotationPathValueImpl.prototype.eSet = function(featureID, newValue) {
        switch (featureID) {
        case IAstPackage.ANNOTATION_PATH_VALUE__NAME_PATH:
            this.setNamePath(newValue);
            return;
        }
        AbstractAnnotationValueImpl.prototype.eSet.call(this, featureID,
                newValue);
    };
    AnnotationPathValueImpl.prototype.eUnset = function(featureID) {
        switch (featureID) {
        case IAstPackage.ANNOTATION_PATH_VALUE__NAME_PATH:
            this.setNamePath(null);
            return;
    ...
    AnnotationPathValueImpl.prototype.eIsSet = function(featureID) {
        switch (featureID) {
        case IAstPackage.ANNOTATION_PATH_VALUE__NAME_PATH:
            return this.namePath != null;
        }
        return AbstractAnnotationValueImpl.prototype.eIsSet.call(this,
                featureID);
    };
    ...
    function (NamedDeclarationImpl) {
        ...
        DdlStatementImpl.prototype.getCompilationUnit = function () {
            if (this.compilationUnit != null
                    && this.compilationUnit.eIsProxy()) {
                var oldCompilationUnit = this.compilationUnit;
                this.compilationUnit = this
                        .eResolveProxy(oldCompilationUnit);
        ...
        DdlStatementImpl.prototype.eGet = function(featureID,resolve,coreType) {
            switch (featureID) {
            case IAstPackage.DDL_STATEMENT__COMPILATION_UNIT:
                if (resolve) {
                    return this.getCompilationUnit();
        ...
        DdlStatementImpl.prototype.eUnset = function(featureID) {
            switch (featureID) {
            case IAstPackage.DDL_STATEMENT__COMPILATION_UNIT:
                this.setCompilationUnit(null);
                return;
            }
            NamedDeclarationImpl.prototype.eUnset.call(this,featureID);
        };
    ...
    function (ElementDeclarationImpl,rnd,EObjectContainmentEList,require) {
        ...
        AssociationDeclarationImpl.prototype.eGet = function(featureID,resolve,coreType) {
            switch (featureID) {
                ...
                case IAstPackage.ASSOCIATION_DECLARATION__ON_EXPRESSION:
                    return this.getOnExpression();
                case IAstPackage.ASSOCIATION_DECLARATION__ON_TOKEN:
        ...
        AssociationDeclarationImpl.prototype.eIsSet = function(featureID) {
            switch (featureID) {
                ...
                case IAstPackage.ASSOCIATION_DECLARATION__ON_TOKEN:
                    return AssociationDeclarationImpl.ON_TOKEN_EDEFAULT == null ? this.onToken != null : !AssociationDeclarationImpl.ON_TOKEN_EDEFAULT===onToken;
            }
            return ElementDeclarationImpl.prototype.eIsSet.call(this,featureID);
        };
 ...
 */
define(
    'commonddl/astmodel/DataSourceImpl',["require", "commonddl/astmodel/SourceRangeImpl", "rndrt/rnd"
    ], //dependencies
    ...
    function (DataSourceImpl,JoinEnum,EObjectContainmentEList,require,rnd) {
        ...
        JoinDataSourceImpl.prototype.eGet = function(featureID,resolve,coreType) {
            switch (featureID) {
                ...
                case IAstPackage.JOIN_DATA_SOURCE__ON_EXPRESSION:
                    return this.getOnExpression();
                case IAstPackage.JOIN_DATA_SOURCE__ON_TOKEN:
                    return this.getOnToken();
            }
        ...
        JoinDataSourceImpl.prototype.eIsSet = function(featureID) {
            switch (featureID) {
                ...
                case IAstPackage.JOIN_DATA_SOURCE__ON_EXPRESSION:
                    return this.onExpression != null;
                case IAstPackage.JOIN_DATA_SOURCE__ON_TOKEN:
                    return JoinDataSourceImpl.ON_TOKEN_EDEFAULT == null ? this.onToken != null : !JoinDataSourceImpl.ON_TOKEN_EDEFAULT===onToken;
            }
...
// 13549d549289c4f3db4ca9c6c51ad0a81341c8df introduce onToken in AssociationDeclaration and JoinDataSource
define(
    'commonddl/astmodel/ViewDefinitionImpl',["commonddl/astmodel/DdlStatementImpl","commonddl/astmodel/EObjectContainmentEList","commonddl/astmodel/ViewSelectImpl","commonddl/astmodel/ViewSelectSetImpl","rndrt/rnd"], //dependencies
    function (DdlStatementImpl,EObjectContainmentEList,ViewSelectImpl,ViewSelectSetImpl,rnd) {
        ...
        ViewDefinitionImpl.prototype.getNames = function() {
            if (this.names != null && this.names.eIsProxy()) {
                var oldNames=this.names;
                this.names=this.eResolveProxy(oldNames);
                if (this.names != oldNames) {
                }
            }
            return this.names;
        };
...
define(
    'commonddl/astmodel/ColumnImpl',["commonddl/astmodel/EObjectImpl","require","rndrt/rnd"], //dependencies
...
define(
    ...
    function (EObjectImpl) {
        ...
        PathEntryImpl.prototype.basicSetParameterBindings = function(
                newParameterBindings, msgs) {
            var oldParameterBindings = this.parameterBindings;
            this.parameterBindings = newParameterBindings;
            return msgs;
        };
        PathEntryImpl.prototype.setParameterBindings = function(
            ...
            if (newParameterBindings != this.parameterBindings) {
                ...
                msgs = this.basicSetParameterBindings(newParameterBindings,
                        msgs);
                if (msgs != null) {
                    msgs.dispatch();
                }
        ...
        PathEntryImpl.prototype.eInverseRemove = function(otherEnd,featureID,msgs) {
            switch (featureID) {
                ...
                case IAstPackage.PATH_ENTRY__PARAMETER_BINDINGS:
                    return this.basicSetParameterBindings(null,msgs);
            }
        };
        PathEntryImpl.prototype.eGet = function(featureID,resolve,coreType) {
            switch (featureID) {
                ...
                case IAstPackage.PATH_ENTRY__PARAMETER_BINDINGS:
                    return this.getParameterBindings();
            }
            return EObjectImpl.prototype.eGet.call(this,featureID,resolve,coreType);
        };
        PathEntryImpl.prototype.eSet = function(featureID,newValue) {
            switch (featureID) {
                ...
                case IAstPackage.PATH_ENTRY__FILTER:
                    ...
                    return;
                case IAstPackage.PATH_ENTRY__PARAMETER_BINDINGS:
                    this.setParameterBindings(newValue);
                    return;
            }
            EObjectImpl.prototype.eSet.call(this,featureID,newValue);
        };
        PathEntryImpl.prototype.eUnset = function(featureID) {
            switch (featureID) {
                ...
                case IAstPackage.PATH_ENTRY__FILTER:
                    ...
                    return;
                case IAstPackage.PATH_ENTRY__PARAMETER_BINDINGS:
                    this.setParameterBindings(null);
                    return;
            }
            EObjectImpl.prototype.eUnset.call(this,featureID);
        };
        PathEntryImpl.prototype.eIsSet = function(featureID) {
            switch (featureID) {
                case IAstPackage.PATH_ENTRY__NAME_TOKEN:
                    return PathEntryImpl.NAME_TOKEN_EDEFAULT == null ? this.nameToken != null : !PathEntryImpl.NAME_TOKEN_EDEFAULT===nameToken;
                case IAstPackage.PATH_ENTRY__FILTER:
...
define(
    'commonddl/astmodel/ViewExtendImpl',["commonddl/astmodel/DdlStatementImpl","rndrt/rnd"], //dependencies
    function (DdlStatementImpl) {
...
define(
    'commonddl/astmodel/LiteralExpressionImpl',["commonddl/astmodel/ExpressionImpl","rndrt/rnd"], //dependencies
...
define(
    'commonddl/astmodel/ExpressionContainerImpl',["commonddl/astmodel/SourceRangeImpl","rndrt/rnd"], //dependencies
    function (SourceRangeImpl,rnd) {
...
define(
    'commonddl/astmodel/EnumerationValueImpl',["commonddl/astmodel/SourceRangeImpl","rndrt/rnd"], //dependencies
    function (SourceRangeImpl,rnd) {
...
define(
    'commonddl/astmodel/ConcatenationExpressionImpl',["commonddl/astmodel/ExpressionImpl","rndrt/rnd"], //dependencies
    function (ExpressionImpl,rnd) {
...
define(
    'commonddl/astmodel/LikeExpressionImpl',["commonddl/astmodel/CompExpressionImpl","rndrt/rnd"], //dependencies
...
define(
    ...
    function (rnd) {
        ...
        TokenUtil.isKeyword = function(t) {
            if (t != null && (rnd.Category.CAT_KEYWORD === t.m_category || rnd.Category.CAT_STRICT_KEYWORD === t.m_category || rnd.Category.CAT_MAYBE_KEYWORD === t.m_category)) {
                return true;
            }
            return false;
        };
...
define(
    ...
    function (CompilationUnitImpl,ViewDefinitionImpl,ViewSelectImpl,ColumnImpl,DataSourceAssociationImpl,require,PathEntryImpl,DataSourceImpl,SelectListEntryImpl,SelectListImpl,CompExpressionImpl,JoinDataSourceImpl,PreAnnotationImpl,AnnotationValueImpl,ViewExtendImpl,BooleanExpressionImpl,LiteralExpressionImpl,ExpressionContainerImpl,AnnotationRecordValueImpl,AnnotationNameValuePairImpl,AnnotationArrayValueImpl,SelectListEntryExtensionImpl,NotExpressionImpl,AnnotationDeclarationImpl,AnonymousTypeDeclarationImpl,AttributeDeclarationImpl,EnumerationDeclarationImpl,EnumerationValueImpl,PathDeclarationImpl,ContextDeclarationImpl,NamespaceDeclarationImpl,EntityDeclarationImpl,AssociationDeclarationImpl,ForeignKeyImpl,TypeDeclarationImpl,UsingDirectiveImpl,StdFuncExpressionImpl,OrderByEntryImpl,ConcatenationExpressionImpl,OrderByImpl,GroupByImpl,InExpressionImpl,GroupByEntryImpl,LikeExpressionImpl,BetweenExpressionImpl,NullExpressionImpl,
              ...
              PrefixRuleFromClauseImpl, PostfixRuleFromClauseImpl,ViewSelectSetImpl,AnnotationPathValueImpl) {
        ...
        AstFactoryImpl.prototype.create = function(eClass) {
            switch (eClass.getClassifierID()) {
                ...
                case IAstPackage.ANNOTATION_PATH_VALUE:
                    return this.createAnnotationPathValue();
                ...
                case IAstPackage.ASPECT_DECLARATION: 
                    return this.createAspectDeclaration();
                ...
                case IAstPackage.PARAMETER_BINDINGS:
                    return this.createParameterBindings();
                case IAstPackage.PARAMETER_BINDING:
                    return this.createParameterBinding();
                default :
        ...
        AstFactoryImpl.prototype.createIProgressMonitorFromString = function(eDataType,initialValue) {
            return EFactoryImpl.prototype.createFromString2.call(this,eDataType,initialValue);
        };
        ...
        AstFactoryImpl.prototype.createTokenFromString = function(eDataType,initialValue) {
            throw new IllegalStateException("Tokens cannot be created from String");
        };
        AstFactoryImpl.prototype.convertTokenToString = function(eDataType,instanceValue) {
            var t = instanceValue;
            return new StringBuffer().append(t.m_lexem).append(" - ")
                    .append(t.m_line).append(":").append(t.m_column)
                    .toString();
        };
        AstFactoryImpl.prototype.createTokenListFromString = function(eDataType,initialValue) {
            return EFactoryImpl.prototype.createFromString2.call(this,initialValue);
        };
        AstFactoryImpl.prototype.convertTokenListToString = function(eDataType,instanceValue) {
            return EFactoryImpl.prototype.convertToString2.call(this,instanceValue);
        };
        ...
        PathExpressionImpl.prototype.eIsSet = function(featureID) {
            switch (featureID) {
                case IAstPackage.PATH_EXPRESSION__ENTRIES:
                    return this.entries != null && !this.entries.isEmpty();
                case IAstPackage.PATH_EXPRESSION__LAST_NAMESPACE_COMPONENT_INDEX:
                    return PathExpressionImpl.LAST_NAMESPACE_COMPONENT_INDEX_EDEFAULT == null ? this.lastNamespaceComponentIndex != null : !PathExpressionImpl.LAST_NAMESPACE_COMPONENT_INDEX_EDEFAULT === this.lastNamespaceComponentIndex;
                case IAstPackage.PATH_EXPRESSION__TABLE_NAME:
                ...
                case IAstPackage.PATH_EXPRESSION__IDENTIFIER_TOKEN:
                    return PathExpressionImpl.IDENTIFIER_TOKEN_EDEFAULT == null ? this.getIdentifierToken() != null : !PathExpressionImpl.IDENTIFIER_TOKEN_EDEFAULT===this.getIdentifierToken();
            }
            return ExpressionImpl.prototype.eIsSet.call(this,featureID);
        };
...
define(
    ...
    function (AbstractDdlCodeCompletionProposal, DdlCodeCompletionType, DdlKeywordCodeCompletionProposal, TokenUtil, BooleanType, AbstractAnnotationImpl, AbstractAnnotationValueImpl, AnnotatedImpl, AnnotationArrayValueImpl, AnnotationDeclarationImpl, AnnotationNameValuePairImpl, AnnotationRecordValueImpl, AnnotationValueImpl, AnonymousTypeDeclarationImpl, ArithmeticExpressionImpl, AssociationDeclarationImpl, IAstFactory, AttributeDeclarationImpl, BetweenExpressionImpl, BooleanExpressionImpl, CaseExpressionImpl, CaseWhenExpressionImpl, CastExpressionImpl, CompExpressionImpl, CompilationUnitImpl, ConcatenationExpressionImpl, ConstDeclarationImpl, DataSourceImpl, DdlStatementImpl, ElementDeclarationImpl, EntityDeclarationImpl, EnumerationDeclarationImpl, EnumerationValueImpl, ExpressionImpl, ExpressionContainerImpl, ForeignKeyImpl, FuncExpressionImpl, FuncParamImpl, FuncWithNamedParamExpressionImpl, GroupByImpl, GroupByEntryImpl, InExpressionImpl, JoinDataSourceImpl, LikeExpressionImpl, LiteralExpressionImpl, NamesImpl, NotExpressionImpl, NullExpressionImpl, OrderByImpl, OrderByEntryImpl, ParameterImpl, PathDeclarationImpl, PathEntryImpl, PathExpressionImpl, PostAnnotationImpl, PreAnnotationImpl, SearchedCaseExpressionImpl, SelectListImpl, SelectListEntryImpl, SelectListEntryExtensionImpl, SimpleCaseExpressionImpl, SourceRangeImpl, StdFuncExpressionImpl, UsingDirectiveImpl, ViewDefinitionImpl, ViewExtendImpl, ViewSelectImpl, JoinEnum, rnd, SapDdlConstants, Region) {
        ...
        AbstractDdlParser.prototype.addAnnotationPathValue = function(
                container, path) {
            if (container == null) {
                return null;
            }
            var annotationValue = IAstFactory.eINSTANCE
                    .createAnnotationPathValue();
        ...
        AbstractDdlParser.prototype.visitTypeUsage = function(namespace,
                name) {
            if (this.visitor != null && this.visitor.visitTypeUsage) {
                this.visitor.visitTypeUsage(namespace, name);
            }
        };
        AbstractDdlParser.prototype.calculateReplacementRegionForPredefinedNames = function(
                currentToken, predefinedNames) {
            ...
            if (Category.CAT_INCOMPLETE === currentToken.m_category) {
                ...
                if (Category.CAT_IDENTIFIER === nextToken.m_category
                        || Category.CAT_LITERAL === nextToken.m_category
                        || Category.CAT_MAYBE_KEYWORD === nextToken.m_category) {
            ...
            if ("." === currentTokenString) {
                var previous = this.getTokenLexem(tokens,
                        currentTokenStartIndex - 1);
                var next = this.getTokenLexem(tokens,
                        currentEndTokenIndex + 1);
                if (previous != null && next != null) {
                    path = previous + "." + next;
                    pathEndIndex = currentEndTokenIndex + 1;
                }
            } else if ("." === this.getTokenLexem(tokens,
                    currentTokenStartIndex - 1)) {
                var previous = this.getTokenLexem(tokens,
                        currentTokenStartIndex - 2);
                if (previous != null) {
            ...
            var pathHasOpeningBracket = "(" === this.getTokenLexem(tokens,
                    pathEndIndex + 1);
            if (pathHasOpeningBracket
                    && rnd.Utils.arrayContains(predefinedNames, path + "(")) {
                var openingBrackets = 1;
                var closingBracketIndex = pathEndIndex + 2;
                for (; closingBracketIndex < tokens.length; closingBracketIndex++) {
                    var tokenLexem = this.getTokenLexem(tokens,
                            closingBracketIndex);
                    if (")" === tokenLexem) {
                        openingBrackets--;
            ...
            var region = new Region(currentToken.m_offset,
                    endToken.m_offset + endToken.m_lexem.length
                            - currentToken.m_offset);
            return region;
        };
...
define(
    ...
    function (
        ...
        DdlScanner.prototype.handleDashArrow = function(s, cursorPos) {
            var dashArrow = "=>";
            var lexem = s.substring(this.tok_begin, this.tok_begin
                    + dashArrow.length);
            ...
            if (this.createDashArrowNoWsTokens) {
                try {
                    ...
                    if (!this.isWS(previous)) {
                        if (!this.isWS(next)
                                || this.isCursor(this.line, this.column
                                        + dashArrow.length, cursorPos)
                                || '\0' == next) {
...
define(
    ...
    function (DdlScanner,rnd,DdlHaltedCallback,ViewDefinitionImpl,DdlStatementMatchUtil,IAstFactory,ViewSelectImpl) {
        ...
        DdlRndParserApi.DdlRndParserApi1 = function(version,versionFactory) {
            ...
            if (indexOfDot != -1) {
                result.version=this.version.substring(0,indexOfDot);
            }else{
        ...
        DdlRndParserApi.prototype.parseSource = function(resolver,source) {
            ...
            var scanner=DdlScanner.DdlScanner7(localByteCode,this.scannerDoesStrictSeparationOfTokensAtPlusMinus,this.scannerDoesStrictSeparationOfTokensAtSlash,this.scannerCreatesDotDotTokens,this.scannerCreatesEnumIdTokens,this.scannerCreatesColonFollowedByIdTokens,this.scannerCreatesPipePipeTokens,this.scannerCreatesDashArrowNoWsTokens);
        ...
        DdlRndParserApi.prototype.getDataSourceForStack = function(
            ...
            if (unusedDataSources.length != 0) {
                for (var pos = unusedDataSources.length - 1; pos >= 0; pos--) {
                    ...
                    currentDataSource = resolver
                            .viewparser_leftjoinDatasource(
                                    currentDataSource, right, null);
                }
            }
        ...
        DdlParseSourceHaltedCallback.prototype.run = function() {
            this.lastParseSourceHaltedTimeout = System.currentTimeMillis();
            return true;
        };
        DdlHaltedCallback.prototype.run = function() {
            return true;
...
define(
    ...
    function (DdlRndParserApi) {
        ...
        DdlParserFactoryBackendVersion.prototype.createResolver1 = function(
                project) {
            var version = this.mapToClientVersion(project);
            var resolver = this.createResolver(version);
            return resolver;
