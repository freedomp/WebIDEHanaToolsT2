jQuery.sap.declare("sap.watt.saptoolsets.fiori.hcp.plugin.fiorilaunchpad.ui.controls.CustomTile");

sap.ui.core.Control.extend("sap.watt.saptoolsets.fiori.hcp.plugin.fiorilaunchpad.ui.controls.CustomTile", {
	metadata: {
		aggregations: {
			"title": {
		...
		rm.write("<div");
    		...
    		rm.write("<div");
		        ...
		        rm.write("<div");
		            ...
		            rm.renderControl(ctrl.getButton());
