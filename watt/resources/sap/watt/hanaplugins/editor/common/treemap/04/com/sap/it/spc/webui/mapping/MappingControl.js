...
/**
 * Constructor for a new Mapping. Accepts an object literal
 * <code>mSettings</code> that defines initial property values, aggregated and
 * associated objects as well as event handlers. If the name of a setting is
 * ambiguous (e.g. a property has the same name as an event), then the framework
 * assumes property, aggregation, association, event in that order. To override
 * this automatic resolution, one of the prefixes "aggregation:", "association:"
 * or "event:" can be added to the name of the setting (such a prefixed name
 * must be enclosed in single or double quotes). The supported settings are:
 * <ul>
 * <li>Properties
 * <ul>
 ...
 * <li>{@link #getInfoSectionSize infoSectionSize} : sap.ui.core.CSSSize
 * (default: '45%')</li>
 ...
 * <li>Aggregations
 * <ul>
 * <li>{@link #getSourceMessageColumns sourceMessageColumns} :
 * sap.ui.table.Column[]</li>
 * <li>{@link #getTargetMessageColumns targetMessageColumns} :
 * sap.ui.table.Column[]</li>
 * </ul>
 * </li>
 * <li>Associations
 ...
 * @class This is used for representing a mapping in a graphical format and
...
/**
 * Creates a new subclass of class com.sap.it.spc.webui.mapping.MappingControl
 * with name <code>sClassName</code> and enriches it with the information
 * contained in <code>oClassInfo</code>. <code>oClassInfo</code> might
 * contain the same kind of informations as described in
 ...
 * @param {function}
 *            [FNMetaImpl] constructor function for the metadata object. If not
 *            given, it defaults to sap.ui.core.ElementMetadata.
...
/**
 * Getter for property <code>sourceMessageTitle</code>. Default value is
 * empty/<code>undefined</code>
 * 
...
/**
 * Setter for property <code>sourceMessageTitle</code>. Default value is
 * empty/<code>undefined</code>
 * 
 * @param {string}
 *            sSourceMessageTitle new value for property
 *            <code>sourceMessageTitle</code>
 * @return {com.sap.it.spc.webui.mapping.MappingControl} <code>this</code> to
...
/**
 * Getter for property <code>targetMessageTitle</code>. Default value is
 * empty/<code>undefined</code>
 * 
...
/**
 * Setter for property <code>targetMessageTitle</code>. Default value is
 * empty/<code>undefined</code>
 * 
 * @param {string}
 *            sTargetMessageTitle new value for property
 *            <code>targetMessageTitle</code>
 * @return {com.sap.it.spc.webui.mapping.MappingControl} <code>this</code> to
 *         allow method chaining
 * @public
...
/**
 * Getter for property <code>transformation</code>. The data that needs to be
 * set on this control. This should be an instance of the model object
 * "com.sap.it.spc.webui.models.Transformation" Default value is empty/<code>undefined</code>
 * 
 ...
 * 
 * @param {object}
 *            oTransformation new value for property <code>transformation</code>
 * @return {com.sap.it.spc.webui.mapping.MappingControl} <code>this</code> to
 *         allow method chaining
 * @public
...
/**
 * Getter for property <code>showInfoSection</code>. To show/hide the
 * information (lower) section Default value is <code>true</code>
 * 
...
/**
 * Setter for property <code>showInfoSection</code>. Default value is
 * <code>true</code>
 * 
 * @param {boolean}
 *            bShowInfoSection new value for property
 *            <code>showInfoSection</code>
 * @return {com.sap.it.spc.webui.mapping.MappingControl} <code>this</code> to
 *         allow method chaining
 * @public
...
/**
 * Getter for property <code>infoSectionSize</code>. The size of the
 * information section to occupy the visible area Default value is
 * <code>45%</code>
 * 
 * @return {sap.ui.core.CSSSize} the value of property
 *         <code>infoSectionSize</code>
 * @public
...
/**
 * Setter for property <code>infoSectionSize</code>. Default value is
 * <code>45%</code>
 * 
 * @param {sap.ui.core.CSSSize}
 *            sInfoSectionSize new value for property
 *            <code>infoSectionSize</code>
 * @return {com.sap.it.spc.webui.mapping.MappingControl} <code>this</code> to
 *         allow method chaining
 * @public
...
/**
 * Getter for property <code>width</code>. Width of the control Default value
 * is <code>100%</code>
 * 
 ...
 * 
 * @param {sap.ui.core.CSSSize}
 *            sWidth new value for property <code>width</code>
 * @return {com.sap.it.spc.webui.mapping.MappingControl} <code>this</code> to
 *         allow method chaining
 * @public
...
/**
 * Getter for property <code>height</code>. Height of the control Default
...
/**
 * Setter for property <code>height</code>. Default value is
 * <code>100%</code>
 * 
 * @param {sap.ui.core.CSSSize}
 *            sHeight new value for property <code>height</code>
 * @return {com.sap.it.spc.webui.mapping.MappingControl} <code>this</code> to
 *         allow method chaining
 * @public
...
/**
 * Getter for aggregation <code>sourceMessageColumns</code>.<br/> The
 * columns for the source message
 * 
...
/**
 * Inserts a sourceMessageColumn into the aggregation named
 * <code>sourceMessageColumns</code>.
 * 
 * @param {sap.ui.table.Column}
 *            oSourceMessageColumn the sourceMessageColumn to insert; if empty,
 *            nothing is inserted
 * @param {int}
 *            iIndex the <code>0</code>-based index the sourceMessageColumn
 *            should be inserted at; for a negative value of <code>iIndex</code>,
 *            the sourceMessageColumn is inserted at position 0; for a value
 *            greater than the current size of the aggregation, the
 *            sourceMessageColumn is inserted at the last position
 * @return {com.sap.it.spc.webui.mapping.MappingControl} <code>this</code> to
 *         allow method chaining
 * @public
...
/**
 * Adds some sourceMessageColumn <code>oSourceMessageColumn</code> to the
 * aggregation named <code>sourceMessageColumns</code>.
 * 
 * @param {sap.ui.table.Column}
 *            oSourceMessageColumn the sourceMessageColumn to add; if empty,
 *            nothing is inserted
 * @return {com.sap.it.spc.webui.mapping.MappingControl} <code>this</code> to
 *         allow method chaining
 * @public
...
/**
 * Removes an sourceMessageColumn from the aggregation named
 * <code>sourceMessageColumns</code>.
 * 
 * @param {int |
 *            string | sap.ui.table.Column} vSourceMessageColumn the
 *            sourceMessageColumn to remove or its index or id
 ...
 * <code>sourceMessageColumns</code>.<br/> Additionally unregisters them
 * from the hosting UIArea.
 * 
 * @return {sap.ui.table.Column[]} an array of the removed elements (might be
 *         empty)
 * @public
...
/**
 * Checks for the provided <code>sap.ui.table.Column</code> in the aggregation
 * named <code>sourceMessageColumns</code> and returns its index if found or
 * -1 otherwise.
 * 
 * @param {sap.ui.table.Column}
 *            oSourceMessageColumn the sourceMessageColumn whose index is looked
 *            for.
 * @return {int} the index of the provided control in the aggregation if found,
 *         or -1 otherwise
 * @public
...
/**
 * Destroys all the sourceMessageColumns in the aggregation named
 * <code>sourceMessageColumns</code>.
 * 
 * @return {com.sap.it.spc.webui.mapping.MappingControl} <code>this</code> to
 *         allow method chaining
...
/**
 * Getter for aggregation <code>targetMessageColumns</code>.<br/> The
 * columns for target message
 * 
 * @return {sap.ui.table.Column[]}
 * @public
...
/**
 * Inserts a targetMessageColumn into the aggregation named
 * <code>targetMessageColumns</code>.
 * 
 * @param {sap.ui.table.Column}
 *            oTargetMessageColumn the targetMessageColumn to insert; if empty,
 *            nothing is inserted
 * @param {int}
 *            iIndex the <code>0</code>-based index the targetMessageColumn
 *            should be inserted at; for a negative value of <code>iIndex</code>,
 *            the targetMessageColumn is inserted at position 0; for a value
 *            greater than the current size of the aggregation, the
 *            targetMessageColumn is inserted at the last position
 * @return {com.sap.it.spc.webui.mapping.MappingControl} <code>this</code> to
 *         allow method chaining
 * @public
...
/**
 * Adds some targetMessageColumn <code>oTargetMessageColumn</code> to the
 * aggregation named <code>targetMessageColumns</code>.
 * 
 * @param {sap.ui.table.Column}
 *            oTargetMessageColumn the targetMessageColumn to add; if empty,
 *            nothing is inserted
 * @return {com.sap.it.spc.webui.mapping.MappingControl} <code>this</code> to
 *         allow method chaining
 * @public
...
/**
 * Removes an targetMessageColumn from the aggregation named
 * <code>targetMessageColumns</code>.
 * 
 * @param {int |
 *            string | sap.ui.table.Column} vTargetMessageColumn the
 *            targetMessageColumn to remove or its index or id
...
/**
 * Removes all the controls in the aggregation named
 * <code>targetMessageColumns</code>.<br/> Additionally unregisters them
 * from the hosting UIArea.
 * 
 * @return {sap.ui.table.Column[]} an array of the removed elements (might be
 *         empty)
...
/**
 * Checks for the provided <code>sap.ui.table.Column</code> in the aggregation
 * named <code>targetMessageColumns</code> and returns its index if found or
 * -1 otherwise.
 * 
 * @param {sap.ui.table.Column}
 *            oTargetMessageColumn the targetMessageColumn whose index is looked
 *            for.
 * @return {int} the index of the provided control in the aggregation if found,
 *         or -1 otherwise
 * @public
...
/**
 * Destroys all the targetMessageColumns in the aggregation named
 * <code>targetMessageColumns</code>.
 * 
 * @return {com.sap.it.spc.webui.mapping.MappingControl} <code>this</code> to
 *         allow method chaining
...
com.sap.it.spc.webui.mapping.MappingControl.prototype._onMappingCreate = function(chId, evId, oData) {
	...
	// fire mapping created event
	this._fireLibraryEvent(MappingLibrary.Events.MAPPING_CREATED, oData);
	// update UI
	this._drawMappings();
...
com.sap.it.spc.webui.mapping.MappingControl.prototype._onMappingUpdate = function(chId, evId, oData) {
	...
	// fire mapping updated event
	this._fireLibraryEvent(MappingLibrary.Events.MAPPING_UPDATED, oData);
	// update UI
	this._drawMappings();
	this._setSelectedMapping(oMapping.id);
};
...
com.sap.it.spc.webui.mapping.MappingControl.prototype._onMappingDelete = function(chId, evId, oData) {
	...
	// fire mapping deleted event
	this._fireLibraryEvent(MappingLibrary.Events.MAPPING_DELETED, oData);
	// update UI
	this.clearSelection();
	this._drawMappings();
};
...
com.sap.it.spc.webui.mapping.MappingControl.prototype._onMessageRowSelectionChange = function(oEvent) {
	var i, oData, oMessageTable, sMessageType, iCurrentIndex, sXPath, oContext, aSelectedIndices, bSelected, aChangedIndices, aSelectedNodes, bExecuteDefault, selctedIndicesSource, selctedIndicesTarget;
	selctedIndicesSource, selctedIndicesTarget;
	...
	if (this._bUserTrigger) {
		...
		iCurrentIndex = oEvent.mParameters.rowIndex;
		aChangedIndices = oEvent.mParameters.rowIndices;
		aSelectedIndices = oMessageTable.getSelectedIndices();
		bSelected = aChangedIndices.indexOf(iCurrentIndex) !== -1 && aSelectedIndices.indexOf(iCurrentIndex) !== -1;
		if (bSelected) {
			oContext = oEvent.mParameters.rowContext;
			if (oContext) {
				aSelectedNodes = [];
				selctedIndicesSource = this._getSourceTable().getSelectedIndices();
				selctedIndicesTarget = this._getTargetTable().getSelectedIndices();
				for (i = 0; i < selctedIndicesSource.length; i++) {
					aSelectedNodes.push(this._getSourceTable().getContextByIndex(selctedIndicesSource[i]).getObject());
				}
				for (i = 0; i < selctedIndicesTarget.length; i++) {
					aSelectedNodes.push(this._getTargetTable().getContextByIndex(selctedIndicesTarget[i]).getObject());
				}
				bExecuteDefault = this.fireNodeSelectionChange({
			...
			this._fireLibraryEvent(MappingLibrary.Events.MAPPING_SELECT, {});
		}
	}
};
...
com.sap.it.spc.webui.mapping.MappingControl.prototype._createGraphicalArea = function() {
	...
	this._oConstantTextField = new sap.ui.commons.TextField({
		visible : (this.getEnableConstantAssignment() && this.getEditMode())
...
com.sap.it.spc.webui.mapping.MappingControl.prototype._createInfoArea = function() {
	// INFO: Informational area contains a strip of tabs about mapping
	// information, search results of both source and target message
	// structures
	// INFO: The tabs containing search results appear only when a query happens
	// in respective structures and disappears once the query is
	// cleared
	this.oInfoArea = new sap.m.IconTabBar({
		width : this._sDefaultCSSSize,
		height : this._sDefaultCSSSize,
		expandable : false,
		expanded : true
...
com.sap.it.spc.webui.mapping.MappingControl.prototype.setShowInfoSection = function(bShowInfoSection) {
	...
	if (bShowInfoSection !== this.getShowInfoSection()) {
		...
		if (bShowInfoSection) {
			oFullArea.setSplitterPosition((100 - parseInt(this.getInfoSectionSize(), 10)) + "%");
...
com.sap.it.spc.webui.mapping.MappingControl.prototype.onBeforeRendering = function() {
	...
	//Change default model binding size from 100 to 1000

	if (!!this._getSourceTable()) {

		this._getSourceTable().getBinding("rows").getModel().setSizeLimit(1000);
	}

	if (!!this._getTargetTable()) {

		this._getTargetTable().getBinding("rows").getModel().setSizeLimit(1000);
	}
...
com.sap.it.spc.webui.mapping.MappingControl.prototype._expandToFirstChild = function(table) {
	var rootContext, i, context, oBinding;
...
com.sap.it.spc.webui.mapping.MappingControl.prototype._getRowIndex = function(oMessageTable, sXPath) {
	...
	for (i = 0; i < oBinding.getLength(); i++) {
		...
		if (sXPath === sTemp) {
			...
			if (iTemp >= iLevel && !oBinding.isExpanded(i)) {
				iLevel = iTemp;
...
com.sap.it.spc.webui.mapping.MappingControl.prototype._updateTable = function(oTable, oData) {
	var oSource, aRowIndices, aXPaths, isVisible = false, i;
	var iFirstVisibleIndex, iLastVisibleIndex;
	if (!this._bUserTrigger) {
		return this;
	}
	...
	iFirstVisibleIndex = oTable.getFirstVisibleRow();
	iLastVisibleIndex = iFirstVisibleIndex + oTable.getRows().length - 1;
	aXPaths = com.sap.it.spc.webui.mapping.utils.getXPathsInMappings(oTable.data("messageType"), oData.mappingIds, this.getTransformation());
	aRowIndices = this._getRowIndices(oTable, aXPaths, true);
	if (aRowIndices.length !== 0 || oSource !== oTable) {
		oTable.clearSelection();
	}
	for (i = 0; i < aRowIndices.length; i++) {
		oTable.addSelectionInterval(aRowIndices[i], aRowIndices[i]);
		if (aRowIndices[i] >= iFirstVisibleIndex && aRowIndices[i] <= iLastVisibleIndex) {
			isVisible = true;
		}
	}

	if (oSource !== oTable && !isVisible) {
		this._setFirstVisibleRow(oTable, aRowIndices);
	}
...
com.sap.it.spc.webui.mapping.MappingControl.prototype._getSelectedMapping = function() {
	var sMappingId = null;
	if(this._aSelectedMappingIDs && this._aSelectedMappingIDs.length > 0 ) {
		sMappingId = this._aSelectedMappingIDs[0];
	}
	if (sMappingId) {
			...
			if (oContext) {
				oPresentation = this._mPresenterRegistry.listener.call(this._mPresenterRegistry.context || this, oContext.getObject(),
						oTable === oSourceTable ? MappingLibrary.ENTITY_TYPE.SOURCE : MappingLibrary.ENTITY_TYPE.TARGET, {
							expanded : oBinding.isExpanded(i + iStartIndex)
						});
...
com.sap.it.spc.webui.mapping.MappingControl.prototype._highlightMappings = function(chId, evId, data) {
	...
	if (data) {
		aMappingIds = data.mappingIds;
	} else {
		aMappingIds = this._aSelectedMappingIDs;
	}
...
com.sap.it.spc.webui.mapping.MappingControl.prototype.scrollDown = function(oEvent) {
	var that = this, previewPoint = {}, $this = this.$();
	var $ga, $source, $target, $canvas, iSourceStart, iSourceEnd, iTragetStart, iTargetEnd;
	$ga = $this.find(".webuiGraphicalArea");
	$source = $ga.find(".sapUiBorderLayoutBegin");
	$target = $ga.find(".sapUiBorderLayoutEnd");
	$canvas = $ga.find(".sapUiBorderLayoutCenter");
	iSourceStart = $source.offset().left;
	iSourceEnd = iSourceStart + $source.width();
	iTragetStart = $target.offset().left;
	iTargetEnd = iTragetStart + $target.width();

	previewPoint.y = $ga.height() - parseInt($canvas.css("top"), 10);

	if (oEvent.clientX >= iSourceStart && oEvent.clientX <= iSourceEnd) {
		that._getSourceTable().setFirstVisibleRow(that._getSourceTable().getFirstVisibleRow() + 1);
		previewPoint.x = 0;
	}
	if (oEvent.clientX >= iTragetStart && oEvent.clientX <= iTargetEnd) {
		that._getTargetTable().setFirstVisibleRow(that._getTargetTable().getFirstVisibleRow() + 1);
		previewPoint.x = $canvas.outerWidth();
	}
...
com.sap.it.spc.webui.mapping.MappingControl.prototype._confirmDelete = function(oEvent, sAction) {
	...
	if (sAction === "mapping") {
		sap.m.MessageBox.confirm(oRb.getText("MC_CONFIRM_DELETE_MAP"), {
			onClose : function(sResponse) {
				if (sResponse === "OK") {
					that._deleteMapping();
				}
			},
			styleClass : "mem-m-messageBox",
			title : oRb.getText("MC_CONFIRM_DELETE_HEAD")
		});
		...
		sap.m.MessageBox.confirm(oRb.getText("MC_CONFIRM_DELETE_CONNECTION"), {
			onClose : function(sResponse) {
				if (sResponse === "OK") {
...
com.sap.it.spc.webui.mapping.MappingControl.prototype._createPathInfo = function(sXPath, oMessageTable) {
	...
	for (i = 0; i < oBinding.getLength(); i++) {
		...
		if (sQPath === sPath || (!oBinding.isExpanded(i) && sQPath.indexOf(sPath) !== -1 && sQPath.charAt(sPath.length) === "/")) {
			oInfo = {};
			oInfo.xpath = sXPath;
...
com.sap.it.spc.webui.mapping.MappingControl.prototype._getDragInfo = function(element, type) {
	var x = null, y, $tableRow, oTable = null, oContext, xPath = "", bIsLeaf = false;
	...
	if (oContext !== undefined) {
		...
		bIsLeaf = oTable.getBinding().getNodeContexts(oContext).length > 0;
	}
	return {
		x : x,
		y : y,
...
com.sap.it.spc.webui.mapping.MappingControl.prototype._expandRow = function(element, oTable) {
	...
	if (!!oContext) {
		if (!oTable.isExpanded(iAbsoluteRowIndex)) {
...
com.sap.it.spc.webui.mapping.MappingControl.prototype._isMapped = function(element, oTable) {
	...
	if(oContext && oContext.getProperty("xpath")) {
...
com.sap.it.spc.webui.mapping.MappingControl.prototype._createDefaultMapping = function(element, sTableType, sXPath) {
	var oContext, mapping;
...
com.sap.it.spc.webui.mapping.MappingControl.prototype._unbindJQueryEvents = function() {
	...
	var $this = this.$();
	$this.find(".sapUiHorizontalSplitterBar").unbind();
	...
	$this.find(".webuiGraphicalArea .sapUiBorderLayoutCenter").unbind();
...
com.sap.it.spc.webui.mapping.MappingControl.prototype._setupDragAndDrop = function() {
	...
	$this.find(".sapUiHorizontalSplitterBar").mouseover(function(oEvent) {
		if (!!that._dragStart) {
			...
			function(oEvent) {
				...
				if (!!that._dragStart) {
					...
					if ($this.find(".webuiSourceMessage table").find($(ce)).length > 0 && !that._dragStart.isSourceTable) {
						bDraggable = that._isValidMapping(ce, that._getSourceTable());
						...
						oGR.showPreview(that._dragStart.x, that._dragStart.y, oEvent.clientX - canvas.offset().left, oEvent.clientY
							...
							// if drag and drop is on target table
							// header
							&& !that._dragStart.isTargetTable) {
						bDraggable = that._isValidMapping(ce);
						document.body.style.cursor = bDraggable ? "auto" : "not-allowed";
						canvas = $(".webuiTargetMessage .sapUiTableCol");
						oGR.showPreview(that._dragStart.x, that._dragStart.y, $(".webuiGraphicalArea .sapUiBorderLayoutCenter").outerWidth(),
								canvas.outerHeight(true) / 2);
	...
	$this.find(".webuiGraphicalArea").mouseup(
			function(oEvent) {
				document.body.style.cursor = "auto";
				var currentElement, bDroppable, oTable;
				$this = that.$();
				if (!!that._dragStart) {
					oGR.cancelPreview();
					...
					if ($this.find(".webuiSourceMessage table").find($(currentElement)).length > 0 && !that._dragStart.isSourceTable) {
						bDroppable = that._isValidMapping(currentElement, that._getSourceTable());
						if (bDroppable) {
							// dropPoint =
							// that._getDragInfo(currentElement,
							// "source");
							// that._createDefaultMapping(currentElement,
							// "source", that._dragStart.xPath);
							that._createMapping(currentElement, "source");
						}
					} else if ($this.find(".webuiTargetMessage table").find($(currentElement)).length > 0 && !that._dragStart.isTargetTable) {

						oTable = that._getTargetTable();

						bDroppable = that._isValidMapping(currentElement, oTable);
						if (bDroppable) {

							that._createMapping(currentElement, "target");
						}
						...
						bDroppable = that._isValidMapping(currentElement);
						if (bDroppable) {

							// oSourceContext =
							// that._getRowContextFromElement(that._dragStart.startElement,
							// that._getSourceTable());
							that._createMapping(currentElement, "target");
						}
	...
	$this.find(".webuiGraphicalArea").mouseover(function(oEvent) {
		var currentElement, previewPoint;
		$this = that.$();
		if (!!that._dragStart) {
			oGR.cancelPreview();
			currentElement = this.ownerDocument.elementFromPoint(oEvent.clientX, oEvent.clientY);
			if ($this.find(".webuiSourceMessage .sapUiTableTr").find($(currentElement)).length > 0 && !that._dragStart.isSourceTable) {
			...
			} else if ($this.find(".webuiTargetMessage .sapUiTableTr").find($(currentElement)).length > 0 && !that._dragStart.isTargetTable) {
				that._expandRow(currentElement, that._getTargetTable());
				previewPoint = that._getDragInfo(currentElement, "target");
				oGR.showPreview(that._dragStart.x, that._dragStart.y, previewPoint.x, previewPoint.y);
			} else if ($this.find(".webuiSourceMessage .sapUiTableCol").find($(currentElement)).length > 0 && !that._dragStart.isSourceTable) {
			...
			} else if ($this.find(".webuiTargetMessage .sapUiTableCol").find($(currentElement)).length > 0 && !that._dragStart.isTargetTable) {
				that.scrollable = true;
	...
	$(document).mousemove(function(oEvent) {
		if (!!that._dragStart) {
			...
			canvas = $this.find(".sapUiBorderLayoutCenter");
			oGR.cancelPreview();
			oGR.showPreview(that._dragStart.x, that._dragStart.y, oEvent.clientX - canvas.offset().left, oEvent.clientY - canvas.offset().top);
		}
	});
...
com.sap.it.spc.webui.mapping.MappingControl.prototype._adjustInformationColumnsForTheFirstTime = function(oInfoTable) {
	...
	for (i = 1; i < iFnColIndex; i++) {
		...
		if (!!colWidth) {
			iGiven++;
			remaining -= parseInt(colWidth, 10);
		}
	}
	if (remaining !== 0) {
...
com.sap.it.spc.webui.mapping.MappingControl.prototype.addInfoTab = function(oTab) {
	this._getInfoArea().addItem(oTab);
	return this;
};

com.sap.it.spc.webui.mapping.MappingControl.prototype.insertInfoTab = function(oTab, iIndex) {
	this._getInfoArea().insertItem(oTab, iIndex);
	return this;
};

com.sap.it.spc.webui.mapping.MappingControl.prototype.destroyInfoTabs = function(oTab) {
	this._getInfoArea().destroyItems();
	return this;
};

com.sap.it.spc.webui.mapping.MappingControl.prototype.removeInfoTab = function(value) {
	this._getInfoArea().removeItem(value);
	return this;
};

com.sap.it.spc.webui.mapping.MappingControl.prototype.getInfoTabs = function() {
	return this.oInfoArea.getItems();
};

com.sap.it.spc.webui.mapping.MappingControl.prototype.setSelectedInfoTabKey = function(sKey) {
	this._getInfoArea().setSelectedKey(sKey);
};

com.sap.it.spc.webui.mapping.MappingControl.prototype.setSourceMessagePath = function(sPath) {
	this._getSourceTable().bindRows(sPath);
};

com.sap.it.spc.webui.mapping.MappingControl.prototype.setTargetMessagePath = function(sPath) {
	this._getTargetTable().bindRows(sPath);
};
...
com.sap.it.spc.webui.mapping.MappingControl.prototype.registerCustomMappingValidator = function(fCallback) {
	if (typeof fCallback === "function") {
		this._mappingValidatorCallback = fCallback;
	} else {
		this._mappingValidatorCallback = null;
	}
};

com.sap.it.spc.webui.mapping.MappingControl.prototype.unregisterCustomMappingValidator = function() {
	this._mappingValidatorCallback = null;
};
 ...
 * @returns
 */
com.sap.it.spc.webui.mapping.MappingControl.prototype._validateMapping = function(element) {
	var oTargetContext, oSourceContext, oSource, oTarget;

	if (this._dragStart.isSourceTable) {
		oTargetContext = this._getRowContextFromElement(element, this._getTargetTable());
		oSourceContext = this._getRowContextFromElement(this._dragStart.startElement, this._getSourceTable());
	} else {
		oSourceContext = this._getRowContextFromElement(element, this._getSourceTable());
		oTargetContext = this._getRowContextFromElement(this._dragStart.startElement, this._getTargetTable());
	}

	oSource = oSourceContext.getObject();
	oTarget = null;
	...
	if (typeof this._mappingValidatorCallback === "function") {
		return this._mappingValidatorCallback([ oSource ], oTarget);
	} else {
		return false;
	}
...
com.sap.it.spc.webui.mapping.MappingControl.prototype.registerCustomMappingCreator = function(fCallback) {
	if (typeof fCallback === "function") {
		this._mappingCreatorCallback = fCallback;
	} else {
		this._mappingCreatorCallback = null;
	}
};

com.sap.it.spc.webui.mapping.MappingControl.prototype.unregisterCustomMappingCreator = function() {
	this._mappingCreatorCallback = null;
};

/**
 * @returns true if callback handled mapping creation. false if default
 *          implementation should take care of it.
 */
com.sap.it.spc.webui.mapping.MappingControl.prototype._createCustomMapping = function(oMappingData) {
	// var sMappingId, dropPoint;

	if (typeof this._mappingCreatorCallback === "function") {
		return this._mappingCreatorCallback(oMappingData);
	} else {

		/*
		 * if (this._isMapped(currentElement, oTable)) { sMappingId =
		 * this._getMappingIds(dropPoint.xPath, "target")[0]; dropPoint =
		 * oGR.getFunctionXY(sMappingId);
		 * this._addNewConnectionToMapping(sMappingId, this._dragStart.xPath,
		 * "source"); } else if (oTargetContext) { // drop onto existing element
		 * this._createDefaultMapping(currentElement, "target",
		 * this._dragStart.xPath); }
		 */
		return false;
	}
};

com.sap.it.spc.webui.mapping.MappingControl.prototype._isValidMapping = function(currentElement, oTable) {
	var result;
	if (typeof this._mappingValidatorCallback === "function") {
		result = this._validateMapping(currentElement);
	} else {
		result = this._isValidRowElement(currentElement, oTable);
	}
	return result;
};

com.sap.it.spc.webui.mapping.MappingControl.prototype._createMapping = function(currentElement, sType) {
	var sCounterType, oTable, dropPoint, oTargetContext = null, oSourceContext, sMappingId;

	oTargetContext = this._getRowContextFromElement(currentElement, this._getTargetTable());
	oSourceContext = this._getRowContextFromElement(this._dragStart.startElement, this._getSourceTable());

	if (typeof this._mappingCreatorCallback === "function") {
		this._createCustomMapping({
		...
		sCounterType = sType === "target" ? "source" : "target";
		dropPoint = this._getDragInfo(currentElement, sType);
		oTable = this._getTargetTable();
		if (this._isMapped(currentElement, oTable)) {
			sMappingId = this._getMappingIds(dropPoint.xPath, sType)[0];
			// dropPoint = oGR.getFunctionXY(sMappingId);
			this._addNewConnectionToMapping(sMappingId, this._dragStart.xPath, sCounterType);
		} else {
			if (oTargetContext) {
				// drop onto existing element
				this._createDefaultMapping(currentElement, sType, this._dragStart.xPath);
			}
		}
	}
};
