...
sap.ui.define([
		...
		'./library'
	], function(Link, Select, Text, Control, ResizeHandler, ItemNavigation, library) {
	"use strict";
	 ...
	 */
	var BreadCrumbs = Control.extend("sap.uxap.BreadCrumbs", /** @lends sap.uxap.BreadCrumbs.prototype */ { metadata : {
	...
	BreadCrumbs.prototype.onBeforeRendering = function () {
		this._bOnPhone = sap.ui.Device.system.phone;
		this._resetControl();
	};
	...
	BreadCrumbs.prototype._getTubeIcon = function () {
		...
		if (!this.getAggregation("_tubeIcon")) {
			this.setAggregation("_tubeIcon", new sap.ui.core.Icon({
	...
	BreadCrumbs.prototype._getAriaLabelledBy = function () {
		if (!this._oAriaLabelledBy) {
			BreadCrumbs.prototype._oAriaLabelledBy = new sap.ui.core.InvisibleText({
				text: this._getResourceBundle().getText("BREADCRUMB_TRAIL_LABEL")
			}).toStatic();
		}
	 ...
	 *
	 * @private
	 * @returns {sap.ui.core.delegate.ItemNavigation}
	 */
	 ...
	 *
	 * @returns {sap.uxap.i18nModel.ResourceBundle}
	 * @private
	 */
	BreadCrumbs.prototype._getResourceBundle = function () {
