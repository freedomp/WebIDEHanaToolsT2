...
sap.ui.define([	"jquery.sap.global" ], function(jQuery) {  //EXC_JSHINT_002 
	 ...
	 */
	var ODataControlSelector = function(oMetaData, oParent, oTypes) {  //EXC_JSLINT_021
	...
	ODataControlSelector.prototype.getCreator = function(bBlockSmartLinkCreation) {
		...
		if (!this._oParent.getEditable() || !this._oParent.getEnabled() || !this._oParent.getContextEditable()) {
	...
	ODataControlSelector.prototype._isUOMDisplay = function() {
		if (this._oMetaData.annotations.uom) {
			if (this._oParent.getProposedControl() === "ObjectNumber" && this._oParent.data("suppressUnit") !== "true") {
