...
com.sap.it.spc.webui.mapping.MappingControl.prototype._onMessageRowSelectionChange = function(oEvent) {
	var oData, oMessageTable, sMessageType, iCurrentIndex, sXPath, oContext, aSelectedIndices, bSelected, aChangedIndices, aSelectedNodes, bExecuteDefault;
...
com.sap.it.spc.webui.mapping.MappingControl.prototype._updateTable = function(oTable, oData) {
	...
	aXPaths = com.sap.it.spc.webui.mapping.utils
			.getXPathsInMappings(oTable.data("messageType"), oData.mappingIds, this.getTransformation());
...
com.sap.it.spc.webui.mapping.MappingControl.prototype._confirmDelete = function(oEvent, sAction) {
	...
	if (sAction === "mapping") {
		sap.m.MessageBox.confirm(
			oRb.getText("MC_CONFIRM_DELETE_MAP"),
			{
