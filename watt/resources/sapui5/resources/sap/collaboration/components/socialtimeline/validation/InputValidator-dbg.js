...
//		this._validateEnableSocial();
	...
	isBusinessObjectMapValid: function(oBusinessObjectMap){
		...
		else if(!oBusinessObjectMap.serviceModel || !oBusinessObjectMap.collection || !oBusinessObjectMap.applicationContext || !oBusinessObjectMap.servicePath){
			this._oLogger.error("The object passed to the method setBusinessObjectMap has property 'serviceModel', 'collection', 'applicationContext', or 'servicePath' as undefined.");
			isValid = false;
		}
