 ...
 */
/**
 * reinhold.kautzleben@sap.com - added support for async. test execution (requirejs)
 */
(function() {
    ...
    window.QUnitReporter = {
        start: function(func) {
            QUnit.jUnitReport = func;
            ...
            QUnit.moduleStart(function(data) {
                currentModule = currentRun.moduleMap[data.name];
                if (!currentModule) {
                    ...
                    currentRun.moduleMap[data.name] = currentModule;
                }
            });

            QUnit.testStart(function(data) {
                currentModule = currentRun.moduleMap[data.module];
                ...
                if (!currentModule) {
                    ...
                    currentRun.modules.push(currentModule);
                    currentRun.moduleMap[data.module] = currentModule;
                }
                ...
                currentModule.testMap[data.name] = currentTest;
            });
            ...
            QUnit.log(function(data) {
                ...
                currentTest = currentModule.testMap[data.name];
