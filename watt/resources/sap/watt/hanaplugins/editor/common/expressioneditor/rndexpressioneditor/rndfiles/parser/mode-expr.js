    ...
    function(aceRequire, exports, module) {
        ...
        function getEditor() {
            ...
            if (visibleAceContent !== null) {
                var par = visibleAceContent.parentElement.parentElement.parentElement;
                var aceeditor = ace.edit(par);
                editor = aceeditor;
        ...
        function createRndTok(AceRndTokenizer, language) {
            if (editor !== null && editor !== undefined) {
                rndTok = new AceRndTokenizer(Range, language);
        ...
        require(["rndrt/rnd", "commonddl/commonddlNonUi", "sap/watt/hanaplugins/editor/common/expressioneditor/rndexpressioneditor/rndfiles/parser/ExprTokenizerWithWorker"], function(rnd, commonddl, ExprTokenizerWithWorker) {
            getEditor();
        ...
        var Mode = function() {
            ...
            this.setEditor = function(aceEditor, language) {
                var that = this;
                ...
                require(["rndrt/rnd", "commonddl/commonddlNonUi", "sap/watt/hanaplugins/editor/common/expressioneditor/rndexpressioneditor/rndfiles/parser/ExprTokenizerWithWorker"], function(rnd, commonddl, ExprTokenizerWithWorker) {
                    createRndTok(ExprTokenizerWithWorker, that.language);
                    Utils = rnd.Utils;
                });
            };
        ...
        (function() {
            ...
            this.setEditor = function(aceEditor) {
                editor = aceEditor;
            };
