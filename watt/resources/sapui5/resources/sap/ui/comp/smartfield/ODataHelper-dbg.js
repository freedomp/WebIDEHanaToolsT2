 ...
 */
sap.ui.define([	"jquery.sap.global", "sap/ui/comp/odata/MetadataAnalyser", "sap/ui/comp/smartfield/AnnotationHelper" ], function(jQuery, MData, Annotation) { // EXC_JSHINT_002
	"use strict";
	 ...
	 */
	var ODataHelper = function(oModel, oUtil, oMetaModel) { // EXC_JSLINT_021
		if (oModel) {
		...
		return function(oParam) {
			try {
				oControl.fireChange({
					...
					unitChanged: bUnit,
					validated: oParam.mParameters["validated"] // EXC_JSHINT_018
				});
			} catch (ex) {
