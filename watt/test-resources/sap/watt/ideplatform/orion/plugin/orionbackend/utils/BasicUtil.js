define(function(){
	...
	BasicUtil.prototype.initializeTestProject = function() {
		...
		return this._createProject(this._sTestProjectName);
...
//	};
	...
	BasicUtil.prototype._createProject = function(sProjectName) {
		var that = this;
		return this._oFileService.getRoot().then(function(oRoot) {
			return oRoot.createFolder(sProjectName);
		});
