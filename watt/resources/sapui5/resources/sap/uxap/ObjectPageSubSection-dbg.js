...
sap.ui.define(['sap/ui/core/CustomData', 'sap/ui/layout/Grid', './ObjectPageSectionBase', './ObjectPageSubSectionLayout',
	'./ObjectPageSubSectionMode', './BlockBase', './library'
], function (CustomData, Grid, ObjectPageSectionBase, ObjectPageSubSectionLayout, ObjectPageSubSectionMode, BlockBase, library) {
	"use strict";
	...
	ObjectPageSubSection.prototype._getGrid = function () {
		if (!this.getAggregation("_grid")) {
			this.setAggregation("_grid", new sap.ui.layout.Grid({
	...
	ObjectPageSubSection.prototype._applyLayout = function (oLayoutProvider) {
		...
		this._calcBlockColumnLayout(aVisibleBlocks, oLayoutConfig);
	...
	ObjectPageSubSection.prototype._afterRenderingTitleOnLeftLayout = function () {
		...
		if (!this._iResizeId) {
			this._iResizeId = sap.ui.core.ResizeHandler.register(this, this._titleOnLeftSynchronizeLayouts.bind(this));
		}
	...
	ObjectPageSubSection.prototype._titleOnLeftSynchronizeLayouts = function () {
		jQuery.sap.delayedCall(50 /* dom painting */, this, function () {
			var bUseTitleOnTheLeftLayout = (this._$grid.hasClass("sapUiRespGridMedia-Std-Desktop")
			|| this._$grid.hasClass("sapUiRespGridMedia-Std-LargeDesktop"));
	...
	ObjectPageSubSection.prototype._switchSubSectionMode = function (sSwitchToMode) {
		...
		if (sSwitchToMode === ObjectPageSubSectionMode.Collapsed) {
			...
			this._getSeeMoreButton().setText(this._getResourceBundle().getText("SEE_MORE"));
		} else {
			this.setProperty("mode", ObjectPageSubSectionMode.Expanded, true);
			this._getSeeMoreButton().setText(this._getResourceBundle().getText("SEE_LESS"));
		}
	};
