...
sap.ui.base.Object.extend("sap.collaboration.components.socialtimeline.datahandlers.JamDataHandler",{
	...
	_requestsData: {
		...
		getExternalObjectByExidAndObjectType: {
			url: function() {
				return "/ExternalObjects_FindByExidAndObjectType";
			},
		...
		getFeedEntries: {
			...
			urlParameters: function() {
				return {
					"$expand": "Creator,Creator/MemberProfile"
				};
			},
			successLog: function(oData, response) {
	...
	getExternalObjectByExidAndObjectType: function(sExid, sObjectType) {
		return this._doAllTheThings("getExternalObjectByExidAndObjectType", null, sExid, sObjectType);
	},
