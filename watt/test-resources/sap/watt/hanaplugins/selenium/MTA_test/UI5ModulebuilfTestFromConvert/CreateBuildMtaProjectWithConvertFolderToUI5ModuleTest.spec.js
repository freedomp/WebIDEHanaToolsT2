...
describe('Selenium : Create project from scratch test', function() {
    ...
    it('Create project from scratch', function() {
        ...
        return webIDE.selectRepositoryTreeRoot().then(function() {
            console.log("Create MTA Project "+configuration.projectName);
        return webIDE.createMtaProjectFromTemplate(configuration.projectName);
        }).then(function()
        {console.log("read file "+ configuration.projectName + "/mta.yaml" );
            ...
            return webIDE.createNewFolder(configuration.hdbModuleName);
        }).then(function () {
            console.log("select folder " +configuration.hdbModuleName);
            ...
            return webIDE.convertTo(configuration.projectName + "/"+configuration.hdbModuleName, configuration.hdbModuleType);
        }).then(function(){
            ...
            console.log("select folder " +configuration.projectName + "/"+configuration.hdbModuleName);
            return repositoryBrowser.selectNode(configuration.projectName + "/"+configuration.hdbModuleName);
        }).then (function(){
                console.log("Create folder src under  module "+configuration.hdbModuleName);
                return  webIDE.createNewFolder("src");
        }).then(function () {
            console.log("select folder " +configuration.hdbModuleName);
            ...
            return createSetFileAndSave(configuration.hdinamespace,configuration.projectName +"/"+configuration.hdbModuleName+"/src/"+configuration.hdinamespace,'Files/db/'+configuration.hdinamespace );
        }).then(function () {
            console.log("select folder " +configuration.hdbModuleName);
            return repositoryBrowser.selectNode(configuration.projectName+"/"+configuration.hdbModuleName+"/src");
        }).then(function(){
            return createSetFileAndSave(configuration.hdiconfig,configuration.projectName +"/"+configuration.hdbModuleName+"/src/"+configuration.hdiconfig,'Files/db/'+configuration.hdiconfig );
        }).then (function(){
            ...
            return webIDE.createNewFolder(configuration.nodejsModulName);
        }).then(function () {
            console.log("select folder " +configuration.nodejsModulName);
            return repositoryBrowser.selectNode(configuration.projectName + "/"+configuration.nodejsModulName);
        }).then(function(){
            console.log("Check console exist");
            return webIDE.checkOpenConsole();
        }).then(function () {
            console.log("Convert the js  folder to module");
            return webIDE.convertTo(configuration.projectName + "/"+configuration.nodejsModulName, configuration.jsModuleType);
        }).then(function(){
            console.log("Check convert status");
            return webIDE.checkConvertStatus(configuration.nodejsModulName);
            ...
            return repositoryBrowser.selectNode(configuration.projectName+"/"+configuration.nodejsModulName);
                ...
                return createSetFileAndSave(configuration.defaultservices,configuration.projectName +"/"+configuration.nodejsModulName+"/"+configuration.defaultservices,'Files/js/'+configuration.defaultservices);
            }).then (function(){
                ...
                return repositoryBrowser.selectNode(configuration.projectName+"/"+configuration.hdbModuleName);
                    ...
                    return webIDE.checkBuildStatus("Build of /"+configuration.projectName+"/"+"db completed");
                }).then(function(){
                    ...
                    return webIDE.runConfiguration(configuration.projectName,configuration.nodejsModulName);
                }).then(function() {
