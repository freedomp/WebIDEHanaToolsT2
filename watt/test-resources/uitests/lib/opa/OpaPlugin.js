	...
	function ($, HashChanger, UI5Object, View) {
		...
		var OpaPlugin = UI5Object.extend("sap.ui.test.OpaPlugin", {
			...
			getControlByGlobalId : function (oOptions) {
				...
				// fix : regexp in iframe (reported as CSN 0000784047 2014)
				...
				return aIds.map(function (sId) {
					...
					var bControlTypeMatches = true;
					if (oOptions.controlType) {
						bControlTypeMatches = oControl instanceof oOptions.controlType;
					}
					return bControlTypeMatches && oControl && !oControl.bIsDestroyed;
				});
			},
