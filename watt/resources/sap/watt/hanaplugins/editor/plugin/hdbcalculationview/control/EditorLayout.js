...
sap.ui.commons.Splitter.extend("sap.watt.hanaplugins.editor.plugin.hdbcalculationview.control.Splitter", {
 ...
 */
sap.ui.commons.Button.extend("sap.watt.hanaplugins.editor.plugin.hdbcalculationview.control.EditorLayoutRotatedButton", {
    metadata: {
        interfaces: ["sap.watt.hanaplugins.editor.plugin.hdbcalculationview.control.EditorLayoutRotatedItem"]
    },
    renderer: {
 ...
 * for details on how to rotate text
 */
sap.ui.commons.Label.extend("sap.watt.hanaplugins.editor.plugin.hdbcalculationview.control.EditorLayoutRotatedLabel", {
    metadata: {
        interfaces: ["sap.watt.hanaplugins.editor.plugin.hdbcalculationview.control.EditorLayoutRotatedItem"]
    },
    renderer: {
...
sap.ui.core.Control.extend("sap.watt.hanaplugins.editor.plugin.hdbcalculationview.control.EditorLayout", {
    ...
    metadata: {
        ...
        aggregations: {
            ...
            "collapsedContentLeft": {
                ...
                type: "sap.watt.hanaplugins.editor.plugin.hdbcalculationview.control.EditorLayoutRotatedItem"
            },
    ...
    init: function() {
        ...
        var content = new sap.watt.hanaplugins.editor.plugin.hdbcalculationview.control.Splitter({
            moved: moved,
