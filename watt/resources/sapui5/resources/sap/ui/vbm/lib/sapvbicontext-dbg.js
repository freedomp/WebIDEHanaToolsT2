...
VBI.VBIContext = function(control) {
	...
	vbcx.DoMinimize = function(scene) {
		...
		var crtl = this.m_Control;

		var bSizeNotChanged = ((thumbObj.nThumbWidth === scene.m_nDivWidth) && (thumbObj.nThumbHeight === scene.m_nDivHeight));
		...
		crtl.setWidth(thumbObj.nThumbWidth);
		crtl.setHeight(thumbObj.nThumbHeight);
