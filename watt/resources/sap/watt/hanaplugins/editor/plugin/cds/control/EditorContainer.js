...
sap.ui.core.Control.extend("sap.watt.hanaplugins.editor.plugin.cds.control.EditorContainer", {

	metadata: {
		aggregations: {
			"content": {
				singularName: "content",
				type: "sap.watt.hanaplugins.editor.plugin.cds.control.Editor"
			}
		},
...
sap.ui.core.Control.extend("sap.watt.hanaplugins.editor.plugin.cds.control.Editor", {
	...
	renderer: function(rm, control) {
		...
		rm.addStyle("width", "100%");
		rm.addStyle("height", "100%");
		/*if(control.getProperty("hidden") === true){
