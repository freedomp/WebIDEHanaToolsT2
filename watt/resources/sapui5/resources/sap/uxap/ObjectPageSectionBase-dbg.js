...
sap.ui.define([	'jquery.sap.global', 'sap/ui/core/Control', './library'],
	function (jQuery, Control, library) {
		...
		/**
		 * Gets the message bundle properties file
		 *
		 * @private
		 */
		ObjectPageSectionBase.prototype._getResourceBundle = function () {
			if (!library.i18nModel) {
				library.i18nModel = new sap.ui.model.resource.ResourceModel({
