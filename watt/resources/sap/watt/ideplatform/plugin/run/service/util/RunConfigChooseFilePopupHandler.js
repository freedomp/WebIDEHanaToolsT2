	...
	var chooseFilePopup = {
		...
		getContent: function(aHtmlFiles, sWindowId) {
			...
			if (!this._oChooseFilePopupFragment) {
				this._oChooseFilePopupFragment = sap.ui.jsfragment(
					"sap.watt.ideplatform.plugin.run.view.RunConfigChooseFilePopup", this);
			}
		...
		dbClicked: function(oEvent) {
			...
			this._sSelectedFilePath = oSelectedRowModel.fullPath;
