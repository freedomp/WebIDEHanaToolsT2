sap.ui.core.mvc.Controller.extend("xmlView.DataBindingView", {
	...
	handleSearch: function () {
		...
		if (searchString && searchString.length > 0) {
			filters = [new sap.ui.model.Filter("SalesOrganization", sap.ui.model.FilterOperator.Contains, searchString)];
		}
